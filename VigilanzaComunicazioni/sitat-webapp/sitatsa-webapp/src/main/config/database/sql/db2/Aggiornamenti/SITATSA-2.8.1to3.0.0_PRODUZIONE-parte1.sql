...
UPDATE W_CONFIG SET VALORE='http://proxycart-int.tix.it/proxy-sitat/services/Sitat' WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.sitatproxy.url';

UPDATE W_CONFIG SET VALORE='0' WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.richiestacup.type';
UPDATE W_CONFIG SET VALORE='https://cupwebwsese.tesoro.it/CUPServicesEsercizio' WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.richiestacup.ws.url';
UPDATE W_CONFIG SET VALORE=null WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.richiestacup.pdd.url';
