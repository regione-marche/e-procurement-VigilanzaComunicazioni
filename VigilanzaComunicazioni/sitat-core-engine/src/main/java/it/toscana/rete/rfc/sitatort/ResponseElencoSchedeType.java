...
public class ResponseElencoSchedeType  implements java.io.Serializable {
    ...
    private it.toscana.rete.rfc.sitatort.FaseEsecuzioneType[] elencoSchede;
    ...
    public ResponseElencoSchedeType(
           ...
           boolean success,
           it.toscana.rete.rfc.sitatort.FaseEsecuzioneType[] elencoSchede) {
           this.error = error;
     ...
     * @return elencoSchede
     */
    public it.toscana.rete.rfc.sitatort.FaseEsecuzioneType[] getElencoSchede() {
        return elencoSchede;
    }
     ...
     * @param elencoSchede
     */
    public void setElencoSchede(it.toscana.rete.rfc.sitatort.FaseEsecuzioneType[] elencoSchede) {
        this.elencoSchede = elencoSchede;
    }

    public it.toscana.rete.rfc.sitatort.FaseEsecuzioneType getElencoSchede(int i) {
        return this.elencoSchede[i];
    }

    public void setElencoSchede(int i, it.toscana.rete.rfc.sitatort.FaseEsecuzioneType _value) {
