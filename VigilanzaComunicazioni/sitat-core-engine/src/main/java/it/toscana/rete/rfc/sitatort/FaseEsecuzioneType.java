...
public class FaseEsecuzioneType  implements java.io.Serializable {
    /* Codice della fase */
    private it.toscana.rete.rfc.sitatort.FaseType codiceFase;
    ...
    public FaseEsecuzioneType(
           it.toscana.rete.rfc.sitatort.FaseType codiceFase,
     ...
     */
    public it.toscana.rete.rfc.sitatort.FaseType getCodiceFase() {
        return codiceFase;
    }
     ...
     */
    public void setCodiceFase(it.toscana.rete.rfc.sitatort.FaseType codiceFase) {
        this.codiceFase = codiceFase;
    }
