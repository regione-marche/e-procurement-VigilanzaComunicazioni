...
public class WsOsservatorio_ServiceLocator extends org.apache.axis.client.Service implements it.toscana.rete.rfc.sitatort.WsOsservatorio_Service {
    ...
    public it.toscana.rete.rfc.sitatort.WsOsservatorio_PortType getWsOsservatorio() throws javax.xml.rpc.ServiceException {
    ...
    public it.toscana.rete.rfc.sitatort.WsOsservatorio_PortType getWsOsservatorio(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            it.toscana.rete.rfc.sitatort.SitatSoapBindingStub _stub = new it.toscana.rete.rfc.sitatort.SitatSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (it.toscana.rete.rfc.sitatort.WsOsservatorio_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                it.toscana.rete.rfc.sitatort.SitatSoapBindingStub _stub = new it.toscana.rete.rfc.sitatort.SitatSoapBindingStub(new java.net.URL(WsOsservatorio_address), this);
                _stub.setPortName(getWsOsservatorioWSDDServiceName());
                return _stub;
            }
        }
