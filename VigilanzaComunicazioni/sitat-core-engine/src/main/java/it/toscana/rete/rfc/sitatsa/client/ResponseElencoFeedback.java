...
public class ResponseElencoFeedback  implements java.io.Serializable {
    ...
    private it.toscana.rete.rfc.sitatsa.client.FeedbackType[] elencoFeedback;
    ...
    public ResponseElencoFeedback(
           ...
           boolean success,
           it.toscana.rete.rfc.sitatsa.client.FeedbackType[] elencoFeedback) {
           this.error = error;
     ...
     */
    public it.toscana.rete.rfc.sitatsa.client.FeedbackType[] getElencoFeedback() {
        return elencoFeedback;
    }
     ...
     */
    public void setElencoFeedback(it.toscana.rete.rfc.sitatsa.client.FeedbackType[] elencoFeedback) {
        this.elencoFeedback = elencoFeedback;
    }

    public it.toscana.rete.rfc.sitatsa.client.FeedbackType getElencoFeedback(int i) {
        return this.elencoFeedback[i];
    }

    public void setElencoFeedback(int i, it.toscana.rete.rfc.sitatsa.client.FeedbackType _value) {
