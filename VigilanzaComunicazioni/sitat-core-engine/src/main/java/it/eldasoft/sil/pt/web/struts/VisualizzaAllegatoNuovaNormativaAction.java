 ...
 */
public class VisualizzaAllegatoNuovaNormativaAction extends ActionBaseNoOpzioni {

	 /** Logger Log4J di classe. */
  private static Logger     logger = Logger.getLogger(VisualizzaAllegatoNuovaNormativaAction.class);
  ...
  protected ActionForward runAction(ActionMapping mapping, ActionForm form,
    ...
    try {
      ...
      if ("piatri".equals(tab)) {
        ...
        this.ptManager.downloadFileAllegatoNuovaNormativa("PIATRI", params, request, response);
      } else if ("flussi".equals(tab)) {
        String idflusso = request.getParameter("idflusso");
        String tipo = request.getParameter("tipo");
        params.put("idFlusso", idflusso);
        params.put("tipo", tipo);
        this.ptManager.downloadFileAllegatoNuovaNormativa("PTFLUSSI", params, request, response);
      }
