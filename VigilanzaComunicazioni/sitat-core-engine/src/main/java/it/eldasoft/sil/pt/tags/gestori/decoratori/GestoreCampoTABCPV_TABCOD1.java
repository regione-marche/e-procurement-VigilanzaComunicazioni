 ...
 * 
 */
public class GestoreCampoTABCPV_TABCOD1 extends GestoreCampoTabellatoGen {

  public GestoreCampoTABCPV_TABCOD1() {
    super(false, "T2");
  }
  ...
  public SqlSelect getSql() {
    ...
    if (datiRiga != null) {
      return new SqlSelect(
          "Select CPVCOD1, CPVDESC from TABCPV "
              + "Where CPVCOD2 = '00' and CPVCOD3 = '00' and CPVCOD1<>'00' and CPVCOD0= ? and CPVCOD = 'S2020' "
              + "Order by CPVDESC", new Object[] { datiRiga.get("CPVCOD0") });
    }
    return null;
  }
