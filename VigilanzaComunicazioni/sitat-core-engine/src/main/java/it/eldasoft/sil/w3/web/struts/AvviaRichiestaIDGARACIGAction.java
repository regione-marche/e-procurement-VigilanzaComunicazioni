...
public class AvviaRichiestaIDGARACIGAction extends ActionBaseNoOpzioni {

  protected static final String       FORWARD_CONTROLLO = "richiestaidgaracigcontrollo";
  protected static final String       FORWARD_RICHIESTA = "richiestaidgaracigrichiesta";

  static Logger                       logger            = Logger.getLogger(AvviaRichiestaIDGARACIGAction.class);
  ...
  protected ActionForward runAction(ActionMapping mapping, ActionForm form,
    ...
    if (logger.isDebugEnabled())
      logger.debug("AvviaRichiestaIDGARACIGAction: inizio metodo");
    ...
    try {
      ...
      if ("W3GARA".equals(entita)) {
        ...
        infoValidazione = this.validazioneIDGARACIGManager.validateW3LOTT(syscon, numgara,
            numlott);
      } else if ("W3SMARTCIG".equals(entita)) {
          infoValidazione = this.validazioneIDGARACIGManager.validateW3SMARTCIG(syscon, numgara);
      }
    ...
    if (logger.isDebugEnabled())
      logger.debug("AvviaRichiestaIDGARACIGAction: fine metodo");
