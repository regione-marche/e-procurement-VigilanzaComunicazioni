 ...
 * 
 */
public class GestoreCampoTABCPV_TABCOD0 extends GestoreCampoTabellatoGen {

  public GestoreCampoTABCPV_TABCOD0() {
    super(false, "T2");
  }

  public SqlSelect getSql() {
    return new SqlSelect(
        "Select CPVCOD0, CPVDESC from TABCPV Where CPVCOD1 = '00' and "
