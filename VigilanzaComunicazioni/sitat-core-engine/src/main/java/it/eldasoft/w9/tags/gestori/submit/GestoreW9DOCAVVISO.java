...
/**
 * Gestore per salvataggio occorrenze in W9DOCAVVISO
 * 
 * @author Mirco.Franzoni
 */
public class GestoreW9DOCAVVISO extends AbstractGestoreChiaveNumerica {
  ...
  public String[] getAltriCampiChiave() {
	  return new String[] { "CODEIN", "IDAVVISO", "CODSISTEMA" };
  }
   ...
   * per il salvataggio dei documenti dell'avviso
   * 
            ...
            if (updateOccorrenza) {
              ...
              if (formFile != null) {
                if (formFile.getFileSize() > 0 && formFile.getFileSize() <= MAX_FILE_SIZE) {
                  ...
                  newDataColumnContainer.addColumn("W9DOCAVVISO.FILE_ALLEGATO",
                  ...
                  if (formFile.getFileSize() == 0 && StringUtils.isEmpty(newDataColumnContainer.getString("W9DOCAVVISO.URL"))
