...
public class GestoreCampoW9ConcIdMotivoRisol extends AbstractGestoreCampo {
      ...
      try {
        ...
        if (versioneSimog == 1) {
          listaTabellati = (List<Tabellato>) sqlManager.getElencoTabellati(
              "select TAB1TIP, TAB1DESC from TAB1 where TAB1COD='W3014' and TAB1TIP <= 5 order by TAB1TIP asc", null);
        } else {
          listaTabellati = (List<Tabellato>) sqlManager.getElencoTabellati(
              "select TAB1TIP, TAB1DESC from TAB1 where TAB1COD='W3014' and TAB1ARC is null order by TAB1TIP asc", null);
        }
