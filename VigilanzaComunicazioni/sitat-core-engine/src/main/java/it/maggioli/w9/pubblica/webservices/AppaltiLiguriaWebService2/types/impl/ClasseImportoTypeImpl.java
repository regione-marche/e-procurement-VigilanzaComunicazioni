 ...
 */
public class ClasseImportoTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements it.maggioli.w9.pubblica.webservices.AppaltiLiguriaWebService2.types.ClasseImportoType
{
    
    public ClasseImportoTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType, false);
    }
    
    protected ClasseImportoTypeImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
    {
        super(sType, b);
    }
}
