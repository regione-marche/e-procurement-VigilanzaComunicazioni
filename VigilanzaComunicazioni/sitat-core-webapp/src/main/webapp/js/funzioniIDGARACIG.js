...
function popupValidazioneSMARTCIG(numgara) {
	openPopUpCustom("href=w3/commons/popup-validazione-idgaracig.jsp&entita=W3SMARTCIG&numgara=" + numgara, "validazioneSMARTCIG", 500, 450, "yes", "yes");
}

function popupRichiestaSMARTCIG(codrich) {
	openPopUpCustom("href=w3/commons/popup-avvia-richiesta-idgaracig.jsp&entita=W3SMARTCIG&numgara=" + codrich, "richiestaSMARTCIG", 600, 400, "yes", "yes");
}

function popupAnnullaSMARTCIG(codrich) {
	openPopUpCustom("href=w3/commons/popup-cancella-idgaracig.jsp&entita=W3SMARTCIG&numgara=" + codrich, "annullaSMARTCIG", 600, 400, "yes", "yes");
}
