...
<gene:template file="scheda-template.jsp" gestisciProtezioni="true"
	schema="W9" idMaschera="W9INFOR-scheda">
	...
	<c:set var="flusso" value='994' scope="request" />
	...
	<c:set var="key3" value='${gene:getValCampo(key,"NUM_INFOR")}' scope="request" />

	<c:set var="permessoUser" value='${gene:callFunction3("it.eldasoft.w9.tags.funzioni.GetPermessoUserFunction",pageContext,key,"W9INFOR")}' scope="request" />

	<gene:setString name="titoloMaschera" value='${gene:if("NUOVO"==modo, "Nuova Scheda segnalazione infortuni sul cantiere", "Scheda segnalazione infortuni sul cantiere")}' />

	<gene:redefineInsert name="corpo">
		<gene:formScheda entita="W9INFOR" gestisciProtezioni="true" gestore="it.eldasoft.w9.tags.gestori.submit.GestoreW9INFOR" >
			...
			<gene:gruppoCampi idProtezioni="GEN">
				...
				<gene:campoScheda campo="NUM_INFOR"  modificabile="false" visibile="${modoAperturaScheda ne 'NUOVO'}"/>
				<gene:campoScheda campo="NINFORT" />
				<gene:campoScheda campo="NGIORNATE" />
				<gene:campoScheda campo="IMORTE" />
				<gene:campoScheda campo="IPERMA" />
				<gene:archivio titolo="IMPRESE" obbligatorio="true"
					lista='${gene:if(gene:checkProt( pageContext,"COLS.MOD.W9.W9INFOR.CODIMP"),"gene/impr/impr-lista-popup.jsp","")}'
					...
					campi="IMPR.CODIMP;IMPR.NOMEST" chiave="W9INFOR_CODIMP" 
					...
					<gene:campoScheda campo="NOMEST" entita="IMPR" where="IMPR.CODIMP=W9INFOR.CODIMP" title="Denom. Impresa Aggiudicataria" definizione="T61" />
				</gene:archivio>
			</gene:gruppoCampi>
			<!-- campi per  W9FASI-->
			<gene:campoScheda campo="CODGARA" entita="W9FASI" visibile="false" defaultValue="${codgara}" 
				where="W9FASI.CODGARA = W9INFOR.CODGARA AND W9FASI.CODLOTT = W9INFOR.CODLOTT AND W9FASI.NUM = W9INFOR.NUM_INFOR AND W9FASI.NUM_APPA = W9INFOR.NUM_APPA AND W9FASI.FASE_ESECUZIONE=${flusso}"/>
