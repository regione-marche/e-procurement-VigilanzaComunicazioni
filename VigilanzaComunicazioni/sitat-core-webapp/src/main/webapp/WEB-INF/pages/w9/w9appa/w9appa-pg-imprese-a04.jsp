...
<gene:formScheda entita="W9APPA" gestisciProtezioni="true"
	...
	<gene:campoScheda entita="W9AGGI" campo="CODGARA" where="W9AGGI.CODGARA = ${codgara} and W9AGGI.CODLOTT = ${codlott} and W9AGGI.NUM_APPA = ${num}"
		visibile="false" defaultValue="${datiRiga.W9APPA_CODGARA}" />
	<gene:campoScheda entita="W9AGGI" campo="CODLOTT" where="W9AGGI.CODGARA = ${codgara} and W9AGGI.CODLOTT = ${codlott} and W9AGGI.NUM_APPA = ${num}"
		visibile="false" defaultValue="${datiRiga.W9APPA_CODLOTT}" />
	<gene:campoScheda entita="W9AGGI" campo="NUM_APPA" where="W9AGGI.CODGARA = ${codgara} and W9AGGI.CODLOTT = ${codlott} and W9AGGI.NUM_APPA = ${num}"
		visibile="false" defaultValue="${datiRiga.W9APPA_NUM}" />

	<!-- scheda multipla -->
	<c:if test='${modo ne "NUOVO"}'>
		<gene:callFunction obj="it.eldasoft.w9.tags.funzioni.GetImpreseAggiudicatarieFunction" parametro="${key}" />
	</c:if>
