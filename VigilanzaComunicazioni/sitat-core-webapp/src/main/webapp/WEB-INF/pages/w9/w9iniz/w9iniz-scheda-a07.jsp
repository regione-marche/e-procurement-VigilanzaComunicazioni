...
<gene:template file="scheda-template.jsp" gestisciProtezioni="true" schema="W9" idMaschera="W9INIZ-scheda">
	...
	<gene:setString name="titoloMaschera" value='${gene:if("NUOVO"==modo, "Nuova Fase semplificata iniziale di esecuzione del contratto", "Fase semplificata iniziale di esecuzione del contratto")}' />

	<c:set var="flusso" value='986' scope="request" />
	...
	<c:set var="permessoUser" value='${gene:callFunction3("it.eldasoft.w9.tags.funzioni.GetPermessoUserFunction",pageContext,key,"W9INIZ-A07")}' scope="request" />
	...
	<gene:redefineInsert name="corpo">
		<gene:formPagine gestisciProtezioni="true">
			...
			<gene:pagina title="Dati generali" idProtezioni="DETTFASE"> 
				<jsp:include page="w9iniz-pg-dettaglioFase-a07.jsp" />
			</gene:pagina>
			...
			<gene:pagina title="Incarichi professionali" idProtezioni="TECNI">
				<jsp:include page="w9iniz-pg-incarichi-a07.jsp" />
			</gene:pagina>
