	...
	<gene:redefineInsert name="corpo">
		...
		<!-- campi per  W9FASI-->
			<gene:campoScheda campo="CODGARA" entita="W9FASI" visibile="false" defaultValue="${codgara}" 
				where="W9FASI.CODGARA = W9RITA.CODGARA AND W9FASI.CODLOTT = W9RITA.CODLOTT AND W9FASI.NUM = W9RITA.NUM_RITA AND W9FASI.NUM_APPA = W9RITA.NUM_APPA AND W9FASI.FASE_ESECUZIONE=${flusso}"/>
