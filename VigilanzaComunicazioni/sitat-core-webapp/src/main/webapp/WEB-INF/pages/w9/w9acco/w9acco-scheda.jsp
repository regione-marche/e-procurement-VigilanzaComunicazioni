...
<gene:template file="scheda-template.jsp" gestisciProtezioni="true"	schema="W9" idMaschera="W9ACCO-scheda">
	...
	<gene:redefineInsert name="corpo">
			...
			<gene:campoScheda campo="CODGARA" entita="W9FASI" visibile="false" defaultValue="${codgara}" 
				where="W9FASI.CODGARA = W9ACCO.CODGARA AND W9FASI.CODLOTT = W9ACCO.CODLOTT AND W9FASI.NUM = W9ACCO.NUM_ACCO AND W9FASI.NUM_APPA = W9ACCO.NUM_APPA AND W9FASI.FASE_ESECUZIONE=${flusso}"/>
