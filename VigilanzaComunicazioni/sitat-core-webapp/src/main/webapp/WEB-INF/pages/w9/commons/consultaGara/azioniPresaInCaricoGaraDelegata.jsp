...
<c:choose>
	<c:when test='${! empty requestScope.listaTecnici or ! empty requestScope.listaCodiciDenominazione }'>
		<tr>
			<td class="vocemenulaterale">
				<a href="javascript:confermaInvio();"	tabindex="1500" title="Continua">Continua</a>
			</td>
		</tr>
	</c:when>
	<c:otherwise>
