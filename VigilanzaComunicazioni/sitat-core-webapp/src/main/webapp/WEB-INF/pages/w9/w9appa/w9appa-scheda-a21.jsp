...
<gene:template file="scheda-template.jsp" gestisciProtezioni="true" schema="W9" idMaschera="W9APPA-scheda">
	...
	<c:set var="flusso" value='12' scope="request" />
	...
	<c:set var="permessoUser" value='${gene:callFunction3("it.eldasoft.w9.tags.funzioni.GetPermessoUserFunction",pageContext,key,"W9APPA-A21")}' scope="request" />

	<gene:setString name="titoloMaschera" value='${gene:if("NUOVO"==modo, "Nuova Fase di adesione accordo quadro", "Fase di adesione accordo quadro")}' />
		
	<gene:redefineInsert name="corpo">

		<gene:formPagine gestisciProtezioni="true"> 

			<gene:pagina title="Dati adesione" idProtezioni="ADESIONE">
				<jsp:include page="w9appa-pg-dettaglioFase-a21.jsp" />
			</gene:pagina>
