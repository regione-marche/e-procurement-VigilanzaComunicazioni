...
public class FeedbackType  implements java.io.Serializable {
    ...
    private it.toscana.rete.rfc.sitatsa.client.FaseType scheda;

    /* Progressivo della scheda a cui il feedback riferisce */
    private int num;

    /* Esito dell'operazione di invio della scheda */
    private it.toscana.rete.rfc.sitatsa.client.EsitoType esito;
    ...
    public FeedbackType(
           ...
           it.toscana.rete.rfc.sitatsa.client.FaseType scheda,
           int num,
           it.toscana.rete.rfc.sitatsa.client.EsitoType esito,
     ...
     */
    public it.toscana.rete.rfc.sitatsa.client.FaseType getScheda() {
        return scheda;
    }
     ...
     */
    public void setScheda(it.toscana.rete.rfc.sitatsa.client.FaseType scheda) {
        this.scheda = scheda;
    }
     ...
     */
    public it.toscana.rete.rfc.sitatsa.client.EsitoType getEsito() {
        return esito;
    }
     ...
     */
    public void setEsito(it.toscana.rete.rfc.sitatsa.client.EsitoType esito) {
        this.esito = esito;
    }
