...
public class EsitoType implements java.io.Serializable {
    ...
    public static final EsitoType value1 = new EsitoType(_value1);
    public static final EsitoType value2 = new EsitoType(_value2);
    public static final EsitoType value3 = new EsitoType(_value3);
    public static final EsitoType value4 = new EsitoType(_value4);
    public static final EsitoType value5 = new EsitoType(_value5);
