...
public class ResponseConsultaGara  implements java.io.Serializable {
    ...
    /**
     * Gets the error value for this ResponseConsultaGara.
     * 
     * @return error
     */
    ...
    /**
     * Sets the error value for this ResponseConsultaGara.
     * 
     * @param error
     */
    ...
    /**
     * Gets the success value for this ResponseConsultaGara.
     * 
     * @return success
     */
    ...
    /**
     * Sets the success value for this ResponseConsultaGara.
     * 
     * @param success
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rete.toscana.it/rfc/sitatort/", "ResponseConsultaGara"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "garaXML"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
