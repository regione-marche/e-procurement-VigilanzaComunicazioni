 ...
 */
public class CreazioneXmlManager {
   ...
   * Logger della classe.
   */
  static Logger logger = Logger.getLogger(CreazioneXmlManager.class);
  ...
  public static XmlObject getXmlAvviso(AvvisoBean avvisoBean, SqlManager sqlManager,
    ...
    if (CostantiW9.PUBBLICAZIONE_AVVISO == avvisoBean.getDatiComuni().getCodiceFase()) {
      // Avviso 989
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaPubblicazioneAvvisoDocument(
  ...
  public static XmlObject getXmlPianoTriennale(PianoTriennaleBean pianoTriennaleBean,
    ...
    case CostantiW9.PROGRAMMA_TRIENNALE_LAVORI:
      ...
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaApprovazioneProgrammaLavoriDocument(
    ...
    case CostantiW9.PROGRAMMA_TRIENNALE_FORNITURE_SERVIZI:
      ...
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaApprovazioneProgrammaFornitureServiziDocument(
          pianoTriennaleBean, sqlManager, w9Manager, requestHttp);
      break;
    case CostantiW9.PROGRAMMA_TRIENNALE_OPERE_PUBBLICHE:
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaApprovazioneProgrammaTriennaleOperePubblicheDocument(
          pianoTriennaleBean, sqlManager, w9Manager, requestHttp);
      break;    
    case CostantiW9.PROGRAMMA_BIENNALE_ACQUISTI:
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaApprovazioneProgrammaBiennaleAcquisti(
          pianoTriennaleBean, sqlManager, w9Manager, requestHttp);
      break;
  ...
  /*public static XmlObject getXmlFase(long codiceFase, long progressivoFase, long codiceGara,
    ...
    return CreazioneXmlManager.getXmlGaraLottoFasi(garaLottoBean, sqlManager, w9Manager);
  }*/
  ...
  public static XmlObject getXmlGaraLottoFasi(GaraLottoBean garaLottoBean,
    ...
    case CostantiW9.COMUNICAZIONE_ESITO: // Comunicazione esito
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaComunicazioneEsitoDocument(
    ...
    case CostantiW9.AGGIUDICAZIONE_SOPRA_SOGLIA: // Fase aggiudicazione/affidamento (>150.000 euro) A05
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaAggiudicazioneAppaltoSopraSogliaDocument(
    ...
    case CostantiW9.INIZIO_CONTRATTO_SOPRA_SOGLIA: // Fase iniziale esecuzione contratto (>150.000 euro) A06
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaInizioContrattoSopraSogliaDocument(
          garaLottoBean, sqlManager, w9Manager);
      break;

    case CostantiW9.AVANZAMENTO_CONTRATTO_SOPRA_SOGLIA: // Fase esecuzione e avanzamento del contratto (>150.000 euro) A08
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaAvanzamentoContrattoSopraSogliaDocument(
          garaLottoBean, sqlManager);
      break;

    case CostantiW9.CONCLUSIONE_CONTRATTO_SOPRA_SOGLIA: // Fase di conclusione del contratto (>150.000 euro) A09
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaConclusioneContrattoSopraSogliaDocument(
          garaLottoBean, sqlManager);
      break;

    case CostantiW9.COLLAUDO_CONTRATTO: // Fase di collaudo del contratto A11
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaCollaudoContrattoSopraSogliaDocument(
          garaLottoBean, sqlManager);
      break;

    case CostantiW9.SOSPENSIONE_CONTRATTO: // Sospensione del contratto A12
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaSospensioneContrattoSopraSogliaDocument(
          garaLottoBean, sqlManager);
      break;

    case CostantiW9.VARIANTE_CONTRATTO: // Variante del contratto A13
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaVarianteContrattoSopraSogliaDocument(
          garaLottoBean, sqlManager);
      break;

    case CostantiW9.ACCORDO_BONARIO: // Accordi bonari A14
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaAccordoBonarioContrattoSopraSogliaDocument(
          garaLottoBean, sqlManager);
      break;

    case CostantiW9.SUBAPPALTO: // Subappalti A15
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaSubappaltoContrattoSopraSogliaDocument(
          garaLottoBean, sqlManager);
      break;

    case CostantiW9.ISTANZA_RECESSO: // Istanza di recesso A16
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaRecessoContrattoSopraSogliaDocument(
          garaLottoBean, sqlManager);
      break;

    case CostantiW9.STIPULA_ACCORDO_QUADRO: // Stipula accordo quadro  A20
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaStipulaAccordoQuadroDocument(
          garaLottoBean, sqlManager);
      break;

    case CostantiW9.ADESIONE_ACCORDO_QUADRO: // Adesione accordo quadro A21
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaAdesioneAccordoQuadroDocument(
          garaLottoBean, sqlManager);
      break;

    case CostantiW9.FASE_SEMPLIFICATA_AGGIUDICAZIONE: // Fase aggiudicazione/affidamento appalto (<150.000 euro) A04
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaAggiudicazioneAppaltoSottoSogliaDocument(
          garaLottoBean, sqlManager);
      break;

    case CostantiW9.FASE_SEMPLIFICATA_INIZIO_CONTRATTO: // Fase iniziale esecuzione contratto (<150.000 euro) A07
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaInizioContrattoSottoSogliaDocument(
          garaLottoBean, sqlManager, w9Manager);
      break;

    case CostantiW9.FASE_SEMPLIFICATA_CONCLUSIONE_CONTRATTO: // Fase di conclusione del contratto (<150.000 euro) A10
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaConclusioneContrattoSottoSogliaDocument(
          garaLottoBean, sqlManager);
      break;

    case CostantiW9.SCHEDA_SEGNALAZIONI_INFORTUNI: // Scheda segnalazione infortuni B07
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaInfortunioDocument(
          garaLottoBean, sqlManager);
      break;

    case CostantiW9.INADEMPIENZE_SICUREZZA_REGOLARITA_LAVORI: // Inadempienze predisposizioni sicurezza e regolarita' lavoro B06
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaInadempienzeSicurezzaDocument(
          garaLottoBean, sqlManager);
      break;
    ...
    case CostantiW9.ESITO_NEGATIVO_VERIFICA_CONTRIBUTIVA_ASSICURATIVA: // Esito negativo verifica regolarita' contributiva ed assicurativa B03
      xmlObject =  CreazioneXmlManager.getRichiestaRispostaSincronaEsitoNegCheckRegolaritaDocument(
          garaLottoBean, sqlManager);
      break;
    ...
    case CostantiW9.ESITO_NEGATIVO_VERIFICA_TECNICO_PROFESSIONALE_IMPRESA_AGGIUDICATARIA: // Esito negativo verifica idoneita' tecnico-professionale dell'impresa aggiudicataria B02
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaEsitoNegCheckIdoneitaDocument(
          garaLottoBean, sqlManager);
      break;

    case CostantiW9.APERTURA_CANTIERE: // Apertura cantiere B08
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaAperturaCantiereDocument(
          garaLottoBean, sqlManager);
      break;

    case CostantiW9.ANAGRAFICA_GARA_LOTTI: // Anagrafica Gara e Lotto/i + CIG A03
        xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaAnagraficaLottoGaraDocument(
            garaLottoBean, sqlManager, w9Manager);
      break;

    /*case CostantiW9.GARE_ENTI_NAZIONALI_O_SOTTO_40000: // Gare per enti nazionali o inferiori a 40.000 euro 983
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaGaraEnteNazionaleSotto40000Document(
          garaLottoBean, sqlManager, w9Manager);
      break;*/

    case CostantiW9.ELENCO_IMPRESE_INVITATE_PARTECIPANTI: // Elenco imprese invitate/partecipanti 101
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaElencoImpreseInvitatePartecipantiDocument(
          garaLottoBean, sqlManager);
      break;

    case CostantiW9.AVANZAMENTO_CONTRATTO_APPALTO_SEMPLIFICATO: // Avanzamento contratto appalto semplificato 102
      xmlObject = CreazioneXmlManager.getRichiestaRispostaSincronaAvanzamentoContrattoAppaltoSemplificatoDocument(
          garaLottoBean, sqlManager);
      break;
 
      /*case CostantiW9.MISURE_AGGIUNTIVE_SICUREZZA: // Misure aggiuntive e migliorative sicurezza B04
        RichiestaRichiestaRispostaSincronaCheckMisureSicurezzaDocument misure =
          RichiestaRichiestaRispostaSincronaCheckMisureSicurezzaDocument.Factory.newInstance();
        misure.documentProperties().setEncoding(ENCODING);
        RichiestaRichiestaRispostaSincronaCheckMisureSicurezzaType richiestaMisure =
          misure.addNewRichiestaRichiestaRispostaSincronaCheckMisureSicurezza();

        faseEstesa = richiestaMisure.addNewFase();
        Tab13Type tab13 = richiestaMisure.addNewTab13();

        CreazioneXmlManager.valorizzaFaseEstesaType(faseEstesa, codiceGara, codiceLotto, codiceFase,
            progressivoFase, codiceCompositore, impl, sqlManager);
        CreazioneXmlManager.valorizzaTab13Type(tab13, codGara, codLott, num, sqlManager);
        CreazioneXmlManager.valorizzaListaTab131Type(richiestaMisure, codGara, codLott, num, sqlManager, w9Manager);
  ...
  public static XmlObject getXmlPubblicazioneDocumento(PubblicazioneBean pubblicazioneBean,
    ...
    CreazioneXmlManager.valorizzaFaseType(richiestaPubblicazione.addNewFase(), pubblicazioneBean.getDatiComuniXml());
    ...
    if (listaCigPubblicazione != null && listaCigPubblicazione.size() > 0) {
      for (int i = 0; i < listaCigPubblicazione.size(); i++) {
        ...
        richiestaPubblicazione.addCigLotti(((JdbcParametro) hmCigPubbl.get("CIG")).getStringValue());
      }
    }
    
    // Valorizzazione dei documenti che compongono la pubblicazione
    CreazioneXmlManager.valorizzaDocumentiPubblicazione(richiestaPubblicazione, codiceGara, 
   ...
   */
  public static final ArrayList<XmlValidationError> validaMsgXML(final XmlObject oggettoDoc) throws IOException {
   ...
   * @param nomeCompositore Nome del compositore del flusso
   * @param mailCompositore mail del compositore del flusso
   * @param tipoInvio tipo di invio (Primo invio, rettifica, test)
   * @param noteInvio note del flusso
   * @param cfStazioneAppaltante codice fiscale della S.A. da cui si invia
   * 
   * @param sqlManager SqlManager
   * @throws SQLException SQLException
   * @throws GestoreException GestoreException
   */
  /*private static void valorizzaFaseType(final FaseType fase, final long codiceFase,
      final long codiceCompositore, final String nomeCompositore, final String mailCompositore,
      final Long tipoInvio, final String noteInvio, final String cfStazioneAppaltante) {

    if (StringUtils.isNotEmpty(mailCompositore)) {
      fase.setGUSYSEMAI(mailCompositore);
    } else {
      fase.setGUSYSEMAI("");
    }

    if (StringUtils.isNotEmpty(nomeCompositore)) {
      fase.setW9FLAUTORE(nomeCompositore);
    } else {
      fase.setW9FLAUTORE("");
    }
    ...
    if (W3020Type.Enum.forInt((int) codiceFase) != null) {
      fase.setW3FASEESEC(W3020Type.Enum.forInt((int) codiceFase));
    }

    if (tipoInvio != null) {
      fase.setW3PGTINVIO2(W3998Type.Enum.forString(tipoInvio.toString()));
    }
    if (StringUtils.isNotEmpty(noteInvio)) {
      fase.setW9NOTINVIO(noteInvio);
    }
    if (StringUtils.isNotEmpty(cfStazioneAppaltante)) {
      fase.setW9FLCFSA(cfStazioneAppaltante);
    }
  }*/
   ...
   * @throws GestoreException GestoreException
   */
  /*private static void valorizzaFaseEstesaType(final FaseEstesaType fase, final long codiceGara,
      final long codiceLotto, final long codiceFase, final long progressivoFase, 
      final long codiceCompositore, final String nomeCompositore, final String mailCompositore,
      final Long tipoInvio, final String noteInvio, final String cfStazioneAppaltante,
    ...
    CreazioneXmlManager.valorizzaFaseType(fase, codiceFase, codiceCompositore, nomeCompositore, 
        mailCompositore, tipoInvio, noteInvio, cfStazioneAppaltante);

    String cig = UtilitySITAT.getCIGLotto(codiceGara, codiceLotto, sqlManager);
    if (StringUtils.isNotEmpty(cig)) {
      fase.setW3FACIG(cig);
    }

    if (progressivoFase > 0) {
      fase.setW3NUM5((int) progressivoFase);
    }
  }*/
  ...
  private static void valorizzaFaseEstesaType(final FaseEstesaType fase,
    ...
    // Valorizzazione dei dati in comune con FaseType (FaseEstesaType estende FaseType)
    CreazioneXmlManager.valorizzaFaseType(fase, garaLottoBean.getDatiComuniXml());
    ...
    Long numappa = UtilitySITAT.getNUMAPPA(garaLottoBean, sqlManager);
    if (numappa != null) {
    	fase.setW9NUMAPPA(numappa.intValue());
    }
  }
  ...
  public static RichiestaRichiestaRispostaSincronaEliminazioneSchedaDocument
    ...
    eliminazioneSchedaDocument.documentProperties().setEncoding(CreazioneXmlManager.ENCODING);
    ...
    CreazioneXmlManager.valorizzaFaseEstesaType(faseEstesa, garaLottoBean, sqlManager);
  ...
  private static RichiestaRichiestaRispostaSincronaComunicazioneEsitoDocument
    ...
    comunicazioneEsitoDocument.documentProperties().setEncoding(CreazioneXmlManager.ENCODING);
    ...
    CreazioneXmlManager.valorizzaFaseEstesaType(faseEstesa, garaLottoBean, sqlManager);
    CreazioneXmlManager.valorizzaTab30Type(tab30, codiceGara, codiceLotto, sqlManager, w9Manager);
    CreazioneXmlManager.valorizzaTab192BisType(comunicazioneEsito, codiceGara, codiceLotto,
  ...
  private static RichiestaRichiestaRispostaSincronaAggiudicazioneAppaltoSopra150000Document
    ...
    aggiudicazioneDocument.documentProperties().setEncoding(CreazioneXmlManager.ENCODING);
    ...
    CreazioneXmlManager.valorizzaTab18Type(tab18, codiceGara, codiceLotto,
        progressivoFase, sqlManager);
    CreazioneXmlManager.valorizzaListaTab181Type(listaTab181, codiceGara, codiceLotto,
        progressivoFase, sqlManager);
    CreazioneXmlManager.valorizzaListaTab182Type(listaTab182, codiceGara, codiceLotto,
        progressivoFase, sqlManager);
    CreazioneXmlManager.valorizzaListaTab183Type(listaTab183, codiceGara, codiceLotto,
        progressivoFase, sqlManager);
    
    // Se e' il primo invio, allora invio anche id_scheda_locale e id_scheda_simog, se valorizzazti in DB 
    if (new Long(1).equals(garaLottoBean.getDatiComuniXml().getTipoInvio())) {
    	Long codiceFase =  garaLottoBean.getDatiComuniXml().getCodiceFase();
    	HashMap<String, String> mappa = getDatiW9FASI(codiceGara, codiceLotto, codiceFase, progressivoFase, sqlManager);
	    if (mappa.containsKey("ID_SCHEDA_LOCALE")) {
	    	tab18.setW9FASCHLOC(mappa.get("ID_SCHEDA_LOCALE"));
	    }
	    if (mappa.containsKey("ID_SCHEDA_SIMOG")) {
	    	tab18.setW9FASCHSIM(mappa.get("ID_SCHEDA_SIMOG"));
	    }
    }
  ...
  private static RichiestaRichiestaRispostaSincronaInizioContrattoSopra150000Document
    ...
    CreazioneXmlManager.valorizzaTab19Type(tab19, codiceGara, codiceLotto, progressivoFase,
        sqlManager);
    CreazioneXmlManager.valorizzaListaTab191Type(listaTab191, codiceGara, codiceLotto,
        progressivoFase, sqlManager);
    CreazioneXmlManager.valorizzaTab192Type(richiestaInizioA06, codiceGara, codiceLotto,
        progressivoFase, sqlManager);
    CreazioneXmlManager.valorizzaTab8bis3Type(richiestaInizioA06, codiceGara, codiceLotto,
        progressivoFase, sqlManager);
    CreazioneXmlManager.valorizzaTab8bis31Type(richiestaInizioA06, codiceGara, codiceLotto,
    ...
    Tab8Bis2Type tab19Tab8bis2 = CreazioneXmlManager.getTab8Bis2Type(codiceGara,
    ...
    if (new Long(1).equals(garaLottoBean.getDatiComuniXml().getTipoInvio())) {
    	...
    	HashMap<String, String> mappa = getDatiW9FASI(codiceGara, codiceLotto, codiceFase, progressivoFase, sqlManager);
	    if (mappa.containsKey("ID_SCHEDA_LOCALE")) {
	    	tab19.setW9FASCHLOC(mappa.get("ID_SCHEDA_LOCALE"));
	    }
	    if (mappa.containsKey("ID_SCHEDA_SIMOG")) {
	    	tab19.setW9FASCHSIM(mappa.get("ID_SCHEDA_SIMOG"));
	    }
    }
  ...
  private static RichiestaRichiestaRispostaSincronaAvanzamentoContrattoSopra150000Document
    ...
    avanzamento.documentProperties().setEncoding(CreazioneXmlManager.ENCODING);
    ...
    CreazioneXmlManager.valorizzaTab20Type(tab20, codiceGara, codiceLotto, progressivoFase, sqlManager);
    ...
    if (new Long(1).equals(garaLottoBean.getDatiComuniXml().getTipoInvio())) {
    	...
    	HashMap<String, String> mappa = getDatiW9FASI(codiceGara, codiceLotto, codiceFase, progressivoFase, sqlManager);
	    if (mappa.containsKey("ID_SCHEDA_LOCALE")) {
	    	tab20.setW9FASCHLOC(mappa.get("ID_SCHEDA_LOCALE"));
	    }
	    if (mappa.containsKey("ID_SCHEDA_SIMOG")) {
	    	tab20.setW9FASCHSIM(mappa.get("ID_SCHEDA_SIMOG"));
	    }
    }
  ...
  private static RichiestaRichiestaRispostaSincronaConclusioneContrattoSopra150000Document
    ...
    conclusioneSopraSoglia.documentProperties().setEncoding(CreazioneXmlManager.ENCODING);
    ...
    CreazioneXmlManager.valorizzaFaseEstesaType(faseEstesa, garaLottoBean, sqlManager);
    CreazioneXmlManager.valorizzaTab21Type(tab21, codiceGara, codiceLotto, progressivoFase, sqlManager);
    ...
    if (new Long(1).equals(garaLottoBean.getDatiComuniXml().getTipoInvio())) {
    	...
    	HashMap<String, String> mappa = getDatiW9FASI(codiceGara, codiceLotto, codiceFase, progressivoFase, sqlManager);
	    if (mappa.containsKey("ID_SCHEDA_LOCALE")) {
	    	tab21.setW9FASCHLOC(mappa.get("ID_SCHEDA_LOCALE"));
	    }
	    if (mappa.containsKey("ID_SCHEDA_SIMOG")) {
	    	tab21.setW9FASCHSIM(mappa.get("ID_SCHEDA_SIMOG"));
	    }
    }
  ...
  private static RichiestaRichiestaRispostaSincronaPubblicazioneAvvisoDocument
    ...
    CreazioneXmlManager.valorizzaFaseType(fase, avvisoBean.getDatiComuni());
    CreazioneXmlManager.valorizzaTab7Type(tab7, avvisoBean.getCodiceAvviso(), codein,
    ...
    hm7.put("codsistema", avvisoBean.getCodiceSistema());
    hm7.put("codein", codein);
    hm7.put("numdoc", new Long(1));
  ...
  private static RichiestaRichiestaRispostaSincronaApprovazioneProgrammaLavoriDocument
    ...
    CreazioneXmlManager.valorizzaFaseType(fase, pianoTriennaleBean.getDatiComuni());
    CreazioneXmlManager.valorizzaTab1LType(tab1l, pianoTriennaleBean.getCodicePianoTriennale(),
        sqlManager, w9Manager, requestHttp);
    CreazioneXmlManager.valorizzaListaTab2LType(listaTab2, pianoTriennaleBean.getCodicePianoTriennale(),
        sqlManager);
    CreazioneXmlManager.valorizzaListaTab2Bis1Type(listaTab2bis1, pianoTriennaleBean.getCodicePianoTriennale(),
        sqlManager);
  ...
  private static RichiestaRichiestaRispostaSincronaApprovazioneProgrammaFornitureServiziDocument
    ...
    CreazioneXmlManager.valorizzaFaseType(fase, pianoTriennaleBean.getDatiComuni());
    CreazioneXmlManager.valorizzaTab1FSType(tab1fs, pianoTriennaleBean.getCodicePianoTriennale(),
        sqlManager, w9Manager);
    CreazioneXmlManager.valorizzaListaTab2FSType(listaTab2FS,
  ...
  private static RichiestaRichiestaRispostaSincronaApprovazioneProgrammaTriennaleOperePubblicheDocument
    ...
    CreazioneXmlManager.valorizzaFaseType(fase, pianoTriennaleBean.getDatiComuni());
    CreazioneXmlManager.valorizzaProgrammaOperePubbliche(programma, pianoTriennaleBean.getCodicePianoTriennale(),
        sqlManager, w9Manager, requestHttp);
    InterventoType[] arrayInterventi = CreazioneXmlManager.valorizzaArrayInterventi(
    ...
    InterventoNonRipropostoType[] arrayInterventiNonRiproposti = 
        CreazioneXmlManager.valorizzaArrayInterventiNonRiproposti(pianoTriennaleBean.getCodicePianoTriennale(),
        sqlManager, w9Manager);
  ...
  private static RichiestaRichiestaRispostaSincronaApprovazioneProgrammaBiennaleAcquistiDocument
    ...
    CreazioneXmlManager.valorizzaFaseType(fase, pianoTriennaleBean.getDatiComuni());
    CreazioneXmlManager.valorizzaProgrammaAcquisti(programma, pianoTriennaleBean.getCodicePianoTriennale(),
        sqlManager, w9Manager, requestHttp);
    InterventoType[] arrayInterventi = CreazioneXmlManager.valorizzaArrayInterventi(
        pianoTriennaleBean.getCodicePianoTriennale(), sqlManager, w9Manager, requestHttp);
    if (arrayInterventi != null && arrayInterventi.length > 0) {
  ...
  private static void valorizzaProgrammaOperePubbliche(ProgrammaOperePubblicheType programma, final long codicePianoTriennale,
    ...
    String sqlRecuperaPIATRI = "SELECT "
      ...
      + " DADOZI, TADOZI, NADOZI, URLADOZI, TITADOZI, DPADOZI, " // 32,33,34,35,36,37
      + " TAPTRI, NAPTRI, DAPTRI, URLAPPROV, TITAPPROV, DPAPPROV " // 38,39,40,41,42,43
    ...
    if (verificaEsistenzaValore(datiProgramma.get(indicePiatriVector))) {
      programma.setT2TITOLOADOZ(datiProgramma.get(indicePiatriVector).toString());
    }  //TITADOZI, URLADOZI
    indicePiatriVector++; // indicePiatriVector=37
    if (verificaEsistenzaValore(datiProgramma.get(indicePiatriVector))) {
      programma.setT2DTPUBADOZ(dateString2Calendar(datiProgramma.get(indicePiatriVector).toString()));
    }
    ...
    indicePiatriVector++; // indicePiatriVector=40
    if (verificaEsistenzaValore(datiProgramma.get(indicePiatriVector))) {
      programma.setT2DAPTRI(dateString2Calendar(datiProgramma.get(indicePiatriVector).toString()));
    }
    indicePiatriVector++; // indicePiatriVector=41
    if (verificaEsistenzaValore(datiProgramma.get(indicePiatriVector))) {
      programma.setT2URLAPPROV(datiProgramma.get(indicePiatriVector).toString());
    }
    indicePiatriVector++; // indicePiatriVector=42
    if (verificaEsistenzaValore(datiProgramma.get(indicePiatriVector))) {
      programma.setT2TITOLOAPP(datiProgramma.get(indicePiatriVector).toString());
    }
    indicePiatriVector++; // indicePiatriVector=43
    if (verificaEsistenzaValore(datiProgramma.get(indicePiatriVector))) {
      programma.setT2DTPUBAPP(dateString2Calendar(datiProgramma.get(indicePiatriVector).toString()));
    }
  }
  ...
  private static void valorizzaProgrammaAcquisti(ProgrammaAcquistiType programma, final long codicePianoTriennale,
    ...
    String sqlRecuperaPIATRI = "SELECT "
      ...
      + " MU3TRI, PR1TRI, PR2TRI, PR3TRI, TO1TRI, TO2TRI, TO3TRI, BRETRI, IMPACC, TIPROG, " //18,19,...,26,27
      + " AP1TRI, AP2TRI, AP3TRI, NORMA, "     // 28,29,30,31
      + " TAPTRI, NAPTRI, DAPTRI, TITAPPROV, DPAPPROV, URLAPPROV " // 32,33,34,35,36,37
      + " FROM PIATRI WHERE CONTRI = ? ";
  ...
  private static InterventoType[] valorizzaArrayInterventi(
    ...
    String sqlRecuperaINTERVENTO =
      "select ACQALTINT,ACQVERDI, AL1TRI, AL2TRI, AL3TRI, AL9TRI, "        //  0,.. 5
          ...
          + " TCPINT,  TIPINT, TIPOIN,  TOTINT, UNIMIS, URCINT, "          // 92,.. 97
          + " VALUTAZIONE, VARIATO, CONINT, IM9TRI "                       // 98,.. 101
    ...
    if (listaInterventi != null && listaInterventi.size() > 0) {
      ...
      for (int i = 0; i < listaInterventi.size(); i++) {
        ...
        indiceInterventoVector++; // indiceInterventoVector=101
        if (verificaEsistenzaValore(interventoDB.get(indiceInterventoVector))) {
          intervento.setT2IIM9TRI(Double.parseDouble(interventoDB.get(indiceInterventoVector).toString()));
        }
  ...
  private static InterventoNonRipropostoType[] valorizzaArrayInterventiNonRiproposti(long codicePianoTriennale,
    ...
    String sqlRecuperaINRTRI = 
      "select CUIINT, CUPPRG, DESINT, TOTINT, MOTIVO, PRGINT, CONINT "
    ...
    if (listaInterventiNonRipropostiDB != null && listaInterventiNonRipropostiDB.size() > 0) {
      ...
      for (int i = 0; i < listaInterventiNonRipropostiDB.size(); i++) {
        ...
        indiceVector++; // indiceVector=6
        if (verificaEsistenzaValore(interventoNonRipropostoDB.get(indiceVector))) {
          interventoNonRiproposto.setT2CONINR(new Long(interventoNonRipropostoDB.get(indiceVector).toString()).intValue());
        }
        arrayInterventiNonRiproposti[i] = interventoNonRiproposto;
      }
    }
  ...
  private static ImmobileType[] valorizzaImmobiliOperaIncompiuta(final Long contri, final Long numoi, 
    ...
    String sqlRecuperaIMMTRAI = 
      "select NUMIMM, CUIIMM, DESIMM, COMIST, NUTS, "
          ...
          + " from IMMTRAI where CONTRI=? AND CONINT=0 and NUMOI=? ";
    ...
    if (numoi != null && contri != null) {
      ...
      if (listaImmtrai.size() > 0) {
        ...
        for (int i = 0; i < listaImmtrai.size(); i++) {
          ...
          if (verificaEsistenzaValore(immobileDB.get(indiceImmTraiVector))) {
            immobile.setT2IVA9INT(Double.parseDouble(immobileDB.get(indiceImmTraiVector).toString()));
          }
          
          immobile.setNUMOIIMMTRAI(numoi.intValue());
  ...
  private static OperaIncompiutaType[] valorizzaOpereIncompiute (final Long contri, 
    ...
    String sqlRecuperaOITRI =
      "select AMBITOINT, ANNOULTQE, AVANZAMENTO, CAUSA, CESSIONE, "                 // 0,..,4
          ...
          + " SEZINT, UTILIZZORID, VENDITA, ONERI_SITO "  // 36,37,38,39
    ...
    if (contri != null) {
      ...
      if (listaOitri != null && listaOitri.size() > 0) {
        ...
        for (int i = 0; i < listaOitri.size(); i++) {
          ...
          indiceImmTraiVector++; // indiceImmTraiVector=39
          if (verificaEsistenzaValore(operaIncompiutaDB.get(indiceImmTraiVector))) {
            operaIncompiuta.setONESIOITRP(Double.parseDouble(operaIncompiutaDB.get(indiceImmTraiVector).toString()));
          }
  ...
  private static RichiestaRichiestaRispostaSincronaAvanzamentoContrattoAppaltoSemplificatoDocument
    ...
    CreazioneXmlManager.valorizzaTab33Type(richiestaAvanzamentoContrattoAppaltoSemplificato.addNewTab33(),
  ...
  private static RichiestaRichiestaRispostaSincronaElencoImpreseInvitatePartecipantiDocument
    ...
    CreazioneXmlManager.valorizzaElencoImpreseInvitate(richiestaElencoImpreseInvitatePartecipanti,
   ...
   * @throws IOException
   */
/*  private static RichiestaRichiestaRispostaSincronaGaraEnteNazionaleSotto40000Document
      getRichiestaRispostaSincronaGaraEnteNazionaleSotto40000Document(
          GaraLottoBean garaLottoBean, SqlManager sqlManager, W9Manager w9Manager)
              throws SQLException, GestoreException, ParseException, IOException {
    
    RichiestaRichiestaRispostaSincronaGaraEnteNazionaleSotto40000Document garaEntiNazSotto40000 =
      RichiestaRichiestaRispostaSincronaGaraEnteNazionaleSotto40000Document.Factory.newInstance();
    garaEntiNazSotto40000.documentProperties().setEncoding(ENCODING);
    RichiestaRichiestaRispostaSincronaGaraEnteNazionaleSotto40000Type richiestaGaraEntiNazSotto40000 =
      garaEntiNazSotto40000.addNewRichiestaRichiestaRispostaSincronaGaraEnteNazionaleSotto40000();
 
    Long codiceGara = garaLottoBean.getCodiceGara();
    
    FaseType fase = richiestaGaraEntiNazSotto40000.addNewFase();
    CreazioneXmlManager.valorizzaFaseType(fase, garaLottoBean.getDatiComuniXml());
    
    CreazioneXmlManager.valorizzaTab31Type(richiestaGaraEntiNazSotto40000.addNewTab31(),
        codiceGara, sqlManager, w9Manager);
    CreazioneXmlManager.valorizzaListaTab311Type(richiestaGaraEntiNazSotto40000,
        codiceGara, sqlManager, w9Manager);
    CreazioneXmlManager.valorizzaTab312Type(richiestaGaraEntiNazSotto40000,
        codiceGara, sqlManager, w9Manager);
    return garaEntiNazSotto40000;
  }*/
  ...
  private static RichiestaRichiestaRispostaSincronaAnagraficaLottoGaraDocument
    ...
    CreazioneXmlManager.valorizzaTab4Type(tab4, codiceGara, sqlManager);
    ...
    if (numeroPubblicazioniEsistenti.longValue() == 0) {
      CreazioneXmlManager.valorizzaListaTab41Type(richiestaAnagrafica, codiceGara, sqlManager, w9Manager);
    }
    CreazioneXmlManager.valorizzaListaTab5Type(listaTab5, codiceGara, sqlManager,
        garaLottoBean.isExportIncarichiProfessionali());
    CreazioneXmlManager.valorizzaTab184Type(richiestaAnagrafica, codiceGara, sqlManager);
  ...
  private static RichiestaRichiestaRispostaSincronaAperturaCantiereDocument
    ...
    CreazioneXmlManager.valorizzaTab17Type(tab17, codiceGara, codiceLotto, progressivoFase, sqlManager);
    CreazioneXmlManager.valorizzaTab171Type(aperturaCantiereRichiesta, codiceGara, codiceLotto,
        progressivoFase, sqlManager);
    CreazioneXmlManager.valorizzaTab172Type(aperturaCantiereRichiesta, codiceGara, codiceLotto, 
        progressivoFase, sqlManager);
    CreazioneXmlManager.valorizzaTab173Type(aperturaCantiereRichiesta, codiceGara, codiceLotto, 
        progressivoFase, sqlManager);
  ...
  private static RichiestaRichiestaRispostaSincronaEsitoNegCheckIdoneitaDocument
    ...
    CreazioneXmlManager.valorizzaTab11Type(tab11, codiceGara, codiceLotto, progressivoFase, sqlManager);
  ...
  private static RichiestaRichiestaRispostaSincronaEsitoNegCheckRegolaritaDocument
    ...
    CreazioneXmlManager.valorizzaTab12Type(tab12, codiceGara, codiceLotto, progressivoFase, sqlManager);
  ...
  private static RichiestaRichiestaRispostaSincronaInadempienzeSicurezzaDocument
    ...
    CreazioneXmlManager.valorizzaTab15Type(tab15, codiceGara, codiceLotto, progressivoFase, sqlManager);
  ...
  private static RichiestaRichiestaRispostaSincronaInfortunioDocument
    ...
    CreazioneXmlManager.valorizzaTab16Type(tab16, codiceGara, codiceLotto, progressivoFase, sqlManager);
    return infortunio;
  }
  ...
  private static RichiestaRichiestaRispostaSincronaConclusioneContrattoSotto150000Document
    ...
    CreazioneXmlManager.valorizzaTab9Type(tab9, codiceGara, codiceLotto, progressivoFase, sqlManager);
  ...
  private static RichiestaRichiestaRispostaSincronaInizioContrattoSotto150000Document
    ...
    CreazioneXmlManager.valorizzaTab8bisType(richiestaInizioA07, codiceGara, codiceLotto,
        progressivoFase, sqlManager);
    CreazioneXmlManager.valorizzaTab8bis1Type(richiestaInizioA07, codiceGara, codiceLotto,
        progressivoFase, sqlManager);
    CreazioneXmlManager.valorizzaTab8bis3Type(richiestaInizioA07, codiceGara, codiceLotto,
        progressivoFase, sqlManager);
    CreazioneXmlManager.valorizzaTab8bis31Type(richiestaInizioA07, codiceGara, codiceLotto,
        progressivoFase, sqlManager, w9Manager);
    ...
    Tab8Bis2Type tab8Tab8bis2 = CreazioneXmlManager.getTab8Bis2Type(codiceGara, codiceLotto, 
        progressivoFase, sqlManager);
  ...
  private static RichiestaRichiestaRispostaSincronaAggiudicazioneAppaltoSotto150000Document
    ...
    CreazioneXmlManager.valorizzaFaseEstesaType(faseEstesa, garaLottoBean, sqlManager);
    CreazioneXmlManager.valorizzaTab8Type(tab8, codiceGara, codiceLotto, progressivoFase, sqlManager);
    CreazioneXmlManager.valorizzaListaTab81Type(listaTab81, codiceGara, codiceLotto,
        progressivoFase, sqlManager);
    CreazioneXmlManager.valorizzaListaTab82Type(listaTab82, codiceGara, codiceLotto,
        progressivoFase, sqlManager);
    ...
    if (new Long(1).equals(garaLottoBean.getDatiComuniXml().getTipoInvio())) {
    	...
    	HashMap<String, String> mappa = getDatiW9FASI(codiceGara, codiceLotto, codiceFase, progressivoFase, sqlManager);
	    if (mappa.containsKey("ID_SCHEDA_LOCALE")) {
	    	tab8.setW9FASCHLOC(mappa.get("ID_SCHEDA_LOCALE"));
	    }
	    if (mappa.containsKey("ID_SCHEDA_SIMOG")) {
	    	tab8.setW9FASCHSIM(mappa.get("ID_SCHEDA_SIMOG"));
	    }
    }
  ...
  private static RichiestaRichiestaRispostaSincronaAdesioneAccordoQuadroDocument
    ...
    CreazioneXmlManager.valorizzaTab29Type(tab29, codiceGara, codiceLotto, progressivoFase, sqlManager);
    CreazioneXmlManager.valorizzaListaTab291Type(listaTab291, codiceGara, codiceLotto,
        progressivoFase,sqlManager);
    CreazioneXmlManager.valorizzaListaTab292Type(listaTab292, codiceGara, codiceLotto,
        progressivoFase, sqlManager);
    CreazioneXmlManager.valorizzaListaTab293Type(listaTab293, codiceGara, codiceLotto,
        progressivoFase, sqlManager);
    ...
    if (new Long(1).equals(garaLottoBean.getDatiComuniXml().getTipoInvio())) {
    	...
    	HashMap<String, String> mappa = getDatiW9FASI(codiceGara, codiceLotto, codiceFase, progressivoFase, sqlManager);
	    if (mappa.containsKey("ID_SCHEDA_LOCALE")) {
	    	tab29.setW9FASCHLOC(mappa.get("ID_SCHEDA_LOCALE"));
	    }
	    if (mappa.containsKey("ID_SCHEDA_SIMOG")) {
	    	tab29.setW9FASCHSIM(mappa.get("ID_SCHEDA_SIMOG"));
	    }
    }
  ...
  private static RichiestaRichiestaRispostaSincronaStipulaAccordoQuadroDocument
    ...
    CreazioneXmlManager.valorizzaFaseEstesaType(faseEstesa, garaLottoBean, sqlManager);
    CreazioneXmlManager.valorizzaTab28(tab28, codiceGara, codiceLotto, progressivoFase, sqlManager);
    CreazioneXmlManager.valorizzaTab281(tab281, codiceGara, codiceLotto, progressivoFase, sqlManager);
    ...
    if (new Long(1).equals(garaLottoBean.getDatiComuniXml().getTipoInvio())) {
    	...
    	HashMap<String, String> mappa = getDatiW9FASI(codiceGara, codiceLotto, codiceFase, progressivoFase, sqlManager);
	    if (mappa.containsKey("ID_SCHEDA_LOCALE")) {
	    	tab28.setW9FASCHLOC(mappa.get("ID_SCHEDA_LOCALE"));
	    }
	    if (mappa.containsKey("ID_SCHEDA_SIMOG")) {
	    	tab28.setW9FASCHSIM(mappa.get("ID_SCHEDA_SIMOG"));
	    }
    }
  ...
  private static RichiestaRichiestaRispostaSincronaRecessoContrattoSopra150000Document
    ...
    CreazioneXmlManager.valorizzaTab27Type(tab27, codiceGara, codiceLotto, progressivoFase, sqlManager);
    ...
    if (new Long(1).equals(garaLottoBean.getDatiComuniXml().getTipoInvio())) {
    	...
    	HashMap<String, String> mappa = getDatiW9FASI(codiceGara, codiceLotto, codiceFase, progressivoFase, sqlManager);
	    if (mappa.containsKey("ID_SCHEDA_LOCALE")) {
	    	tab27.setW9FASCHLOC(mappa.get("ID_SCHEDA_LOCALE"));
	    }
	    if (mappa.containsKey("ID_SCHEDA_SIMOG")) {
	    	tab27.setW9FASCHSIM(mappa.get("ID_SCHEDA_SIMOG"));
	    }
    }
  ...
  private static RichiestaRichiestaRispostaSincronaSubappaltoContrattoSopra150000Document
    ...
    CreazioneXmlManager.valorizzaTab26Type(tab26, codiceGara, codiceLotto, progressivoFase, sqlManager);
    ...
    if (new Long(1).equals(garaLottoBean.getDatiComuniXml().getTipoInvio())) {
    	...
    	HashMap<String, String> mappa = getDatiW9FASI(codiceGara, codiceLotto, codiceFase, progressivoFase, sqlManager);
	    if (mappa.containsKey("ID_SCHEDA_LOCALE")) {
	    	tab26.setW9FASCHLOC(mappa.get("ID_SCHEDA_LOCALE"));
	    }
	    if (mappa.containsKey("ID_SCHEDA_SIMOG")) {
	    	tab26.setW9FASCHSIM(mappa.get("ID_SCHEDA_SIMOG"));
	    }
    }
  ...
  private static RichiestaRichiestaRispostaSincronaAccordoBonarioContrattoSopra150000Document
    ...
    CreazioneXmlManager.valorizzaTab25Type(tab25, codiceGara, codiceLotto, progressivoFase, sqlManager);
    ...
    if (new Long(1).equals(garaLottoBean.getDatiComuniXml().getTipoInvio())) {
    	...
    	HashMap<String, String> mappa = getDatiW9FASI(codiceGara, codiceLotto, codiceFase, progressivoFase, sqlManager);
	    if (mappa.containsKey("ID_SCHEDA_LOCALE")) {
	    	tab25.setW9FASCHLOC(mappa.get("ID_SCHEDA_LOCALE"));
	    }
	    if (mappa.containsKey("ID_SCHEDA_SIMOG")) {
	    	tab25.setW9FASCHSIM(mappa.get("ID_SCHEDA_SIMOG"));
	    }
    }
  ...
  private static RichiestaRichiestaRispostaSincronaVarianteContrattoSopra150000Document
    ...
    CreazioneXmlManager.valorizzaTab24Type(tab24, codiceGara, codiceLotto, 
        progressivoFase, sqlManager);
    CreazioneXmlManager.valorizzaListaTab241Type(listaTab241, codiceGara, 
        codiceLotto, progressivoFase, sqlManager);
    ...
    if (new Long(1).equals(garaLottoBean.getDatiComuniXml().getTipoInvio())) {
    	...
    	HashMap<String, String> mappa = getDatiW9FASI(codiceGara, codiceLotto, codiceFase, progressivoFase, sqlManager);
	    if (mappa.containsKey("ID_SCHEDA_LOCALE")) {
	    	tab24.setW9FASCHLOC(mappa.get("ID_SCHEDA_LOCALE"));
	    }
	    if (mappa.containsKey("ID_SCHEDA_SIMOG")) {
	    	tab24.setW9FASCHSIM(mappa.get("ID_SCHEDA_SIMOG"));
	    }
    }
  ...
  private static RichiestaRichiestaRispostaSincronaSospensioneContrattoSopra150000Document
    ...
    CreazioneXmlManager.valorizzaTab23Type(tab23, codiceGara, codiceLotto, progressivoFase, sqlManager);
    ...
    if (new Long(1).equals(garaLottoBean.getDatiComuniXml().getTipoInvio())) {
    	...
    	HashMap<String, String> mappa = getDatiW9FASI(codiceGara, codiceLotto, codiceFase, progressivoFase, sqlManager);
	    if (mappa.containsKey("ID_SCHEDA_LOCALE")) {
	    	tab23.setW9FASCHLOC(mappa.get("ID_SCHEDA_LOCALE"));
	    }
	    if (mappa.containsKey("ID_SCHEDA_SIMOG")) {
	    	tab23.setW9FASCHSIM(mappa.get("ID_SCHEDA_SIMOG"));
	    }
    }
  ...
  private static RichiestaRichiestaRispostaSincronaCollaudoContrattoSopra150000Document
    ...
    CreazioneXmlManager.valorizzaTab22Type(tab22, codiceGara, codiceLotto, 
        progressivoFase, sqlManager);
    CreazioneXmlManager.valorizzaListaTab221Type(listaTab221, codiceGara, 
        codiceLotto, progressivoFase, sqlManager);
    ...
    if (new Long(1).equals(garaLottoBean.getDatiComuniXml().getTipoInvio())) {
    	...
    	HashMap<String, String> mappa = getDatiW9FASI(codiceGara, codiceLotto, codiceFase, progressivoFase, sqlManager);
	    if (mappa.containsKey("ID_SCHEDA_LOCALE")) {
	    	tab22.setW9FASCHLOC(mappa.get("ID_SCHEDA_LOCALE"));
	    }
	    if (mappa.containsKey("ID_SCHEDA_SIMOG")) {
	    	tab22.setW9FASCHSIM(mappa.get("ID_SCHEDA_SIMOG"));
	    }
    }
    ...
    if (StringUtils.isNotBlank(codimp)) {
      ...
      if (listaTeim != null && listaTeim.size() > 0) {
        for (int i = 0; i < listaTeim.size(); i++) {
          ...
          if ((verificaEsistenzaValore(teim.get(1)) && verificaEsistenzaValore(teim.get(2)))
              || verificaEsistenzaValore(teim.get(3))) {
  ...
  /**
   * Gara per ente nazionale o sotto i 40.000 euro: dati generali.
   *
   ...
   * @throws ParseException ParseException
   */
  /*private static void valorizzaTab31Type(final Tab31Type tab31,
      final Long codGara, final SqlManager sqlManager, final W9Manager w9Manager)
  throws SQLException, ParseException {

    String sqlRecuperaGaraEntinaz = "select CODEIN, OGGETTO, IDAVGARA, IMPORTO_GARA, NLOTTI, "
      +	"TIPO_APP, DGURI, DSCADE, RUP, ID_SCELTA_CONTRAENTE, ID_MODO_GARA, TIPO_CONTRATTO "
      +	"from W9GARA_ENTINAZ where CODGARA = ?";

    HashMap< ? , ? > datiGaraEntinaz = sqlManager.getHashMap(sqlRecuperaGaraEntinaz, new Object[]{codGara});

    if (verificaEsistenzaValore(((JdbcParametro) datiGaraEntinaz.get("W9GARA_ENTINAZ.NLOTTI")).getValue())) {
      tab31.setW9GNNLOTTI(((Long) (((JdbcParametro) datiGaraEntinaz.get("W9GARA_ENTINAZ.NLOTTI")).getValue())).intValue());
    }
    if (verificaEsistenzaValore(((JdbcParametro) datiGaraEntinaz.get("W9GARA_ENTINAZ.OGGETTO")).getValue())) {
      tab31.setW9GNOGGETTO(((JdbcParametro) datiGaraEntinaz.get("W9GARA_ENTINAZ.OGGETTO")).getValue().toString());
    }
    if (verificaEsistenzaValore(((JdbcParametro) datiGaraEntinaz.get("W9GARA_ENTINAZ.IDAVGARA")).getValue())) {
      tab31.setW9GNIDGARA(((JdbcParametro) datiGaraEntinaz.get("W9GARA_ENTINAZ.IDAVGARA")).getValue().toString());
    }
    if (verificaEsistenzaValore(((JdbcParametro) datiGaraEntinaz.get("W9GARA_ENTINAZ.IMPORTO_GARA")).getValue())) {
      tab31.setW9GNIGARA(Double.parseDouble(datiGaraEntinaz.get("W9GARA_ENTINAZ.IMPORTO_GARA").toString()));
    }
    if (verificaEsistenzaValore(((JdbcParametro) datiGaraEntinaz.get("W9GARA_ENTINAZ.DGURI")).getValue())) {
      tab31.setW9GNDGURI(dateString2Calendar(datiGaraEntinaz.get("W9GARA_ENTINAZ.DGURI").toString()));
    }
    if (verificaEsistenzaValore(((JdbcParametro) datiGaraEntinaz.get("W9GARA_ENTINAZ.DSCADE")).getValue())) {
      tab31.setW9GNDSCADB(dateString2Calendar(datiGaraEntinaz.get("W9GARA_ENTINAZ.DSCADE").toString()));
    }
    if (verificaEsistenzaValore(((JdbcParametro) datiGaraEntinaz.get("W9GARA_ENTINAZ.ID_SCELTA_CONTRAENTE")).getValue())) {
      tab31.setW9GNIDSCEL(W3005Type.Enum.forString(((JdbcParametro)
          datiGaraEntinaz.get("W9GARA_ENTINAZ.ID_SCELTA_CONTRAENTE")).getValue().toString()));
    }
    if (verificaEsistenzaValore(((JdbcParametro) datiGaraEntinaz.get("W9GARA_ENTINAZ.ID_MODO_GARA")).getValue())) {
      tab31.setW9GNMODGAR(W3007Type.Enum.forString(((JdbcParametro)
          datiGaraEntinaz.get("W9GARA_ENTINAZ.ID_MODO_GARA")).getValue().toString()));
    }
    if (verificaEsistenzaValore(((JdbcParametro) datiGaraEntinaz.get("W9GARA_ENTINAZ.TIPO_APP")).getValue())) {
      tab31.setW9GNTIPOAPP(W3999Type.Enum.forString(((JdbcParametro)
          datiGaraEntinaz.get("W9GARA_ENTINAZ.TIPO_APP")).getValue().toString()));
    }
    if (verificaEsistenzaValore(((JdbcParametro) datiGaraEntinaz.get("W9GARA_ENTINAZ.TIPO_CONTRATTO")).getValue())) {
      tab31.setW9GNTIPOCON(W3Z05Type.Enum.forString(((JdbcParametro)
          datiGaraEntinaz.get("W9GARA_ENTINAZ.TIPO_CONTRATTO")).getValue().toString()));
    }

    String codein = ((JdbcParametro) datiGaraEntinaz.get("W9GARA_ENTINAZ.CODEIN")).getValue().toString();

    Arch1Type arch1 = tab31.addNewArch1();
    CreazioneXmlManager.valorizzaArch1Type(arch1, codein, sqlManager);
  }*/

  /**
   * Gara per ente nazionale o sotto i 40.000 euro: documenti allegati.
   * 
   * Metodo copiato e modificato da valorizzaListaTab41Type
   * 
   * @param garaEnteNazionaleRichiesta RichiestaRichiestaRispostaSincronaAnagraficaLottoGaraType
   * @param codGara Codice della gara
   * @param sqlManager SqlManager
   * @param w9Manager W9Manager
   * @throws SQLException SQLException
   * @throws IOException IOException
   */
/*  private static void valorizzaListaTab311Type(
      final RichiestaRichiestaRispostaSincronaGaraEnteNazionaleSotto40000Type garaEnteNazionaleRichiesta,
      final Long codGara, final SqlManager sqlManager, final W9Manager w9Manager)
  throws SQLException, IOException {

    String sqlRecuperaW9DOCGARA = "SELECT TITOLO, NUMDOC "
      + " FROM W9DOCGARA WHERE CODGARA = ? ORDER BY NUMDOC ASC";
    ...
    if (datiW9DOCGARA != null && datiW9DOCGARA.size() > 0) {
      for (int i = 0; i < datiW9DOCGARA.size(); i++) {
        List< ? > rigaW9DOCGARA = (List< ? >) datiW9DOCGARA.get(i);
        Tab41Type tab41 = garaEnteNazionaleRichiesta.addNewListaTab311();
  ...
  /**
   * Valorizzazione dell'array di oggetti Tab312Type nel flusso Gara enete nazionale e inferiore ai 40.000 euro.
   * 
   * @param richiestaGaraEntiNazSotto40000 RichiestaRichiestaRispostaSincronaGaraEnteNazionaleSotto40000Type
   * @param codGara Codice della gara
   * @param sqlManager SqlManager
   * @param w9Manager W9Manager
   * @throws SQLException SQLException
   ...
   * @throws ParseException ParseException
   */
/*  private static void valorizzaTab312Type(final RichiestaRichiestaRispostaSincronaGaraEnteNazionaleSotto40000Type richiestaGaraEntiNazSotto40000,
      final Long codGara, final SqlManager sqlManager, final W9Manager w9Manager) throws SQLException, IOException, ParseException {

    String sqlRecuperaLottiEsiti = "select CODLOTT, CIG, OGGETTO, IMPORTO_TOT, CPV, "
      + "ID_CATEGORIA_PREVALENTE, CLASCAT, IMP_AGG, IMPORTO_AGGIUDICAZIONE, DATA_VERB_AGGIUDICAZIONE "
      + "from W9LOTT_ENTINAZ where CODGARA = ? order by CODLOTT asc";

    List< ? > listaLottiEsiti = sqlManager.getListHashMap(sqlRecuperaLottiEsiti, new Object[]{ codGara });

    if (listaLottiEsiti != null && listaLottiEsiti.size() > 0) {
      for (int i = 0; i < listaLottiEsiti.size(); i++) {
        Tab312Type tab312 = richiestaGaraEntiNazSotto40000.addNewTab312();

        HashMap< ? , ? > lottoEsito = (HashMap < ? , ? >) listaLottiEsiti.get(i);

        Long codiceLotto = (Long) ((JdbcParametro) lottoEsito.get("W9LOTT_ENTINAZ.CODLOTT")).getValue();

        if (verificaEsistenzaValore((lottoEsito.get("W9LOTT_ENTINAZ.OGGETTO")))) {
          tab312.setW9LNOGGETTO(((JdbcParametro) lottoEsito.get("W9LOTT_ENTINAZ.OGGETTO")).getValue().toString());
        }
        if (verificaEsistenzaValore((lottoEsito.get("W9LOTT_ENTINAZ.CIG")))) {
          tab312.setW9LNCIG(((JdbcParametro) lottoEsito.get("W9LOTT_ENTINAZ.CIG")).getValue().toString());
        }
        if (verificaEsistenzaValore((lottoEsito.get("W9LOTT_ENTINAZ.IMPORTO_TOT")))) {
          tab312.setW9LNIMPTOT(Double.parseDouble(lottoEsito.get("W9LOTT_ENTINAZ.IMPORTO_TOT").toString()));
        }
        if (verificaEsistenzaValore((lottoEsito.get("W9LOTT_ENTINAZ.CPV")))) {
          tab312.setW9LNCPV(((JdbcParametro) lottoEsito.get("W9LOTT_ENTINAZ.CPV")).getValue().toString());
        }
        if (verificaEsistenzaValore((lottoEsito.get("W9LOTT_ENTINAZ.ID_CATEGORIA_PREVALENTE")))) {
          tab312.setW9LNIDCATE(W3Z03Type.Enum.forString(((JdbcParametro)
              lottoEsito.get("W9LOTT_ENTINAZ.ID_CATEGORIA_PREVALENTE")).getValue().toString()));
        }
        if (verificaEsistenzaValore((lottoEsito.get("W9LOTT_ENTINAZ.CLASCAT")))) {
          tab312.setW9LNCLASCAT(W3Z11Type.Enum.forString(((JdbcParametro)
              lottoEsito.get("W9LOTT_ENTINAZ.CLASCAT")).getValue().toString()));
        }
        if (verificaEsistenzaValore((lottoEsito.get("W9LOTT_ENTINAZ.IMP_AGG")))) {
          tab312.setW9LNIMPAGG(((JdbcParametro) lottoEsito.get("W9LOTT_ENTINAZ.IMP_AGG")).getValue().toString());
        }
        if (verificaEsistenzaValore((lottoEsito.get("W9LOTT_ENTINAZ.IMPORTO_AGGIUDICAZIONE")))) {
          tab312.setW9LNIMPAGGI(Double.parseDouble(lottoEsito.get("W9LOTT_ENTINAZ.IMPORTO_AGGIUDICAZIONE").toString()));
        }
        if (verificaEsistenzaValore((lottoEsito.get("W9LOTT_ENTINAZ.DATA_VERB_AGGIUDICAZIONE")))) {
          tab312.setW9LNDVERB(dateString2Calendar(lottoEsito.get("W9LOTT_ENTINAZ.DATA_VERB_AGGIUDICAZIONE").toString()));
        }
        //DATA_VERB_AGGIUDICAZIONE.W9LOTT_ENTINAZ.W9
        if (verificaEsistenzaValore((lottoEsito.get("W9LOTT_ENTINAZ.CLASCAT")))) {
          tab312.setW9LNCLASCAT(W3Z11Type.Enum.forString(((JdbcParametro)
              lottoEsito.get("W9LOTT_ENTINAZ.CLASCAT")).toString()));
        }

        HashMap<String, Object> hashMapFileAllegato = new HashMap<String, Object>();
        hashMapFileAllegato.put("codGara", codGara);
        hashMapFileAllegato.put("codLotto", codiceLotto);
        BlobFile fileAllegato = w9Manager.getFileAllegato("W9LOTT_ENTINAZ", hashMapFileAllegato);
        if (fileAllegato != null && fileAllegato.getStream() != null) {
          tab312.setFile(fileAllegato.getStream());
        }
      }
    }
  }*/
  ...
  throws SQLException, ParseException {
    String sqlRecuperaW9AGGI = "SELECT FLAG_AVVALIMENTO, ID_TIPOAGG, " // 0, 1
      + " RUOLO, CODIMP, CODIMP_AUSILIARIA, ID_GRUPPO, IMPORTO_AGGIUDICAZIONE, PERC_RIBASSO_AGG, PERC_OFF_AUMENTO " // 2, 3, 4, 5, 6, 7, 8
    ...
    if (codGara != null && codLott != null) {
      ...
      for (int i = 0; i < listaW9aggi.size(); i++) {
        ...
        indiceW9aggiVector++; // indiceW9aggiVector=6
        if (verificaEsistenzaValore(w9aggi.get(indiceW9aggiVector))) {
        	tab81.setW3AGIMPAGGI(Double.parseDouble(w9aggi.get(indiceW9aggiVector).toString()));
        }
        indiceW9aggiVector++; // indiceW9aggiVector=7
        if (verificaEsistenzaValore(w9aggi.get(indiceW9aggiVector))) {
        	tab81.setW3AGPERCRIB(Float.parseFloat(w9aggi.get(indiceW9aggiVector).toString()));
        }
        indiceW9aggiVector++; // indiceW9aggiVector=8
        if (verificaEsistenzaValore(w9aggi.get(indiceW9aggiVector))) {
        	tab81.setW3AGPERCOFF(Float.parseFloat(w9aggi.get(indiceW9aggiVector).toString()));
        }
      }
    }
  }
  ...
  private static Tab8Bis2Type getTab8Bis2Type(final long codgara, final long codlott,
    ...
    String sqlRecuperaW9SIC = "SELECT PIANSCIC, DIROPE, TUTOR "
      + "FROM W9SIC WHERE CODGARA = ? AND CODLOTT = ? AND NUM_INIZ = ? ";
   ...
   * @throws ParseException 
   */
/*  private static void valorizzaTab56Type(final Tab5Type tab5, final Long codGara,
      final Long codLott, final SqlManager sqlManager) throws SQLException, ParseException {
    ...
    try {
      if (codGara > 0 && codLott > 0) {
        List< ? > listaW9inca = sqlManager.getListVector(sqlRecuperaW9INCA,
            new Object[] { codGara, codLott, new Long(1) });

        for (int i = 0; i < listaW9inca.size(); i++) {
          tab101 = tab5.addNewTab56();
  ...
  private static void valorizzaTab13Type(final Tab13Type tab13, final long codGara,
    ...
    String sqlRecuperaW9MISSIC = "SELECT DESCMIS, CODIMP " // 0, 1
      + "FROM W9MISSIC WHERE CODGARA = ? AND CODLOTT = ? AND NUM_INIZ = ? ";
  ...
  /**
   * Misure aggiuntive e migliorative della sicurezza: documenti allegati.
   * 
   * @param richiestaMisure RichiestaRichiestaRispostaSincronaCheckMisureSicurezzaType
   * @param codGara Codice della gara
   * @param codLott Codice del lotto
   * @param num Progressivo
   * @param sqlManager SqlManager
   ...
   * @throws IOException IOException
   */
/*  private static void valorizzaListaTab131Type(final
      RichiestaRichiestaRispostaSincronaCheckMisureSicurezzaType richiestaMisure,
      final long codGara, final long codLott, final long num, final SqlManager sqlManager,
      final W9Manager w9Manager) throws SQLException, IOException {

    String sqlRecuperaW9DOCFASE = "SELECT TITOLO, NUMDOC "
      + " FROM W9DOCFASE WHERE CODGARA=? AND CODLOTT=? AND FASE_ESECUZIONE=? AND NUM_FASE=? ORDER BY NUMDOC";

    List< ? > listaW9DOCFASE = sqlManager.getListVector(sqlRecuperaW9DOCFASE,
        new Object[] { codGara, codLott, new Long(CostantiW9.MISURE_AGGIUNTIVE_SICUREZZA), num });

    if (listaW9DOCFASE != null && listaW9DOCFASE.size() > 0) {

      for (int i = 0; i < listaW9DOCFASE.size(); i++) {
        List< ? > rigaW9DOCFASE = (List< ? >) listaW9DOCFASE.get(i);
        Tab41Type tab41 = richiestaMisure.addNewListaTab131();

        if (verificaEsistenzaValore(rigaW9DOCFASE.get(0))) {
          tab41.setW9DGTITOLO(rigaW9DOCFASE.get(0).toString());
        }
        Long numdoc = Long.parseLong(rigaW9DOCFASE.get(1).toString());

        HashMap<String, Object> hashMapFileAllegato = new HashMap<String, Object>();
        hashMapFileAllegato.put("codGara", codGara);
        hashMapFileAllegato.put("codLotto", codLott);
        hashMapFileAllegato.put("fase_esecuzione", new Long(CostantiW9.MISURE_AGGIUNTIVE_SICUREZZA));
        hashMapFileAllegato.put("num_fase", num);
        hashMapFileAllegato.put("numdoc", numdoc);
        BlobFile fileAllegato = w9Manager.getFileAllegato("FASE",
            hashMapFileAllegato);
        if (fileAllegato != null && fileAllegato.getStream() != null) {
          tab41.setFile(fileAllegato.getStream());
        }
  ...
  private static void valorizzaTab18Type(final Tab18Type tab18, final long codGara,
    ...
    String sqlRecuperaW9APPA = "SELECT " //CODGARA, CODLOTT, NUM_APPA, "
      ...
      + "TIPO_ATTO, DATA_ATTO, NUMERO_ATTO, FLAG_RICH_SUBAPPALTO, RELAZIONE_UNICA, CODCUI "  // 40,41,42,43,44,45
      + "FROM W9APPA WHERE CODGARA = ? AND CODLOTT = ? AND NUM_APPA = ? ";
    ...
    if (codGara > 0 && codLotto > 0 && numAppa > 0) {
      ...
      indiceW9appaVector++; // indiceW9appaVector=44
      if (verificaEsistenzaValore(appa.get(indiceW9appaVector))) {
        tab18.setW3RELAZUNIC(convertiFlag(appa.get(indiceW9appaVector).toString()));
      }
      indiceW9appaVector++; //indiceW9appaVector=45
      if (verificaEsistenzaValore(appa.get(indiceW9appaVector))) {
        tab18.setW9APPACODCUI(appa.get(indiceW9appaVector).toString());
      }
    }
  }
  ...
  throws SQLException, ParseException {
    String sqlRecuperaW9AGGI = "SELECT " //CODGARA, CODLOTT, NUM_AGGI, "
      + "FLAG_AVVALIMENTO, ID_TIPOAGG, RUOLO, CODIMP, CODIMP_AUSILIARIA, ID_GRUPPO, IMPORTO_AGGIUDICAZIONE, PERC_RIBASSO_AGG, PERC_OFF_AUMENTO " // 0, 1, 2, 3, 4, 5, 6, 7, 8
      + "FROM W9AGGI WHERE CODGARA = ? AND CODLOTT = ? AND NUM_APPA = ? ";
    Tab81Type tab181;
    ...
    if (codGara > 0 && codLott > 0 && numAppa > 0) {
      ...
      for (int i = 0; i < listaW9aggi.size(); i++) {
        ...
        indiceW9aggiVector++; // indiceW9aggiVector=6
        if (verificaEsistenzaValore(w9aggi.get(indiceW9aggiVector))) {
          tab181.setW3AGIMPAGGI(Double.parseDouble(w9aggi.get(indiceW9aggiVector).toString()));
        }
        indiceW9aggiVector++; // indiceW9aggiVector=7
        if (verificaEsistenzaValore(w9aggi.get(indiceW9aggiVector))) {
          tab181.setW3AGPERCRIB(Float.parseFloat(w9aggi.get(indiceW9aggiVector).toString()));
        }
        indiceW9aggiVector++; // indiceW9aggiVector=8
        if (verificaEsistenzaValore(w9aggi.get(indiceW9aggiVector))) {
          tab181.setW3AGPERCOFF(Float.parseFloat(w9aggi.get(indiceW9aggiVector).toString()));
        }
      }
    }
  }
  ...
  private static void valorizzaTab22Type(final Tab22Type tab22, final long codGara,
    ...
    String sqlRecuperaW9COLL = "SELECT " //CODGARA, CODLOTT, NUM_COLL, "
      ...
      + "TRA_IMPORTO_RICH, LAVORI_ESTESI, TIPO_COLLAUDO " // 32, 33, 34
    ...
    try {
      if (codGara > 0 && codLotto > 0 && numColl > 0) {
        ...
        indiceW9collVector++; // indiceW9collVector=34
        if (verificaEsistenzaValore(coll.get(indiceW9collVector))) {
          tab22.setW9COLLTIPOCOL(W9025Type.Enum.forString(coll.get(indiceW9collVector).toString()));
        }
      }
    } catch (SQLException e) {
      throw new SQLException(e.getMessage());
  ...
  private static void valorizzaTab24Type(final Tab24Type tab24, final long codGara,
      ...
      ParseException {
    String sqlRecuperaW9VARI = "SELECT "
      ...
      + "IMP_SUBTOTALE, IMP_RIDET_FORNIT, IMP_RIDET_LAVORI, IMP_RIDET_SERVIZI, " // 8, 9, 10, 11
      + "NUM_GIORNI_PROROGA, IMP_NON_ASSOG, CIG_NUOVA_PROC " // 12, 13, 14
    ...
    try {
      if (codGara > 0 && codLotto > 0 && numVari > 0) {
        ...
        indiceW9variVector++; // indiceW9variVector=13
        if (verificaEsistenzaValore(vari.get(indiceW9variVector))) {
          tab24.setW3INONAS1(Double.parseDouble(vari.get(indiceW9variVector).toString()));
        }
        indiceW9variVector++; // indiceW9variVector=14
        if (verificaEsistenzaValore(vari.get(indiceW9variVector))) {
          tab24.setW3CIGNPROC(vari.get(indiceW9variVector).toString());
        }
      }
    } catch (SQLException e) {
      throw new SQLException(e.getMessage());
  ...
  private static void valorizzaTab29Type(final Tab29Type tab29, final long codGara, final long codLott,
    ...
    String sqlRecuperaW9APPA = "select IMPORTO_FORNITURE, " // 0
      ...
      + " COD_STRUMENTO, " // 8
      + " IMPORTO_SUBTOTALE, " // 9
      + " DATA_ATTO, NUMERO_ATTO, TIPO_ATTO, "  // 10, 11, 12
      + " IMPORTO_ATTUAZIONE_SICUREZZA, IMPORTO_PROGETTAZIONE, IMP_NON_ASSOG, CODCUI " //13, 14, 15, 16
      + " from W9APPA where CODGARA=? and CODLOTT=? and NUM_APPA=?";
    ...
    if (datiW9APPA != null && datiW9APPA.size() > 0) {
      ...
      indiceW9appaVector++; //indiceW9appaVector=13
      if (verificaEsistenzaValore(datiW9APPA.get(indiceW9appaVector))) {
        tab29.setW3IATTSIC(((Double) ((JdbcParametro) datiW9APPA.get(indiceW9appaVector)).getValue()).doubleValue());
      }
      indiceW9appaVector++; //indiceW9appaVector=14
      if (verificaEsistenzaValore(datiW9APPA.get(indiceW9appaVector))) {
        tab29.setW3IPROGET(((Double) ((JdbcParametro) datiW9APPA.get(indiceW9appaVector)).getValue()).doubleValue());
      }
      indiceW9appaVector++; //indiceW9appaVector=15
      if (verificaEsistenzaValore(datiW9APPA.get(indiceW9appaVector))) {
        tab29.setW3INONAS(((Double) ((JdbcParametro) datiW9APPA.get(indiceW9appaVector)).getValue()).doubleValue());
      }
      indiceW9appaVector++; //indiceW9appaVector=16
      if (verificaEsistenzaValore(datiW9APPA.get(indiceW9appaVector))) {
  ...
  private static void valorizzaListaTab291Type(final ListaTab291Type listaTab291, final long codGara,
    ...
    if (datiW9AGGI != null && datiW9AGGI.size() > 0) {
      for (int i = 0; i < datiW9AGGI.size(); i++) {
        ...
        indiceW9aggiVector++; // indiceW9aggiVector=6
        if (verificaEsistenzaValore(rigaW9AGGI.get(indiceW9aggiVector))) {
        	tab291.setW3AGIMPAGGI(Double.parseDouble(rigaW9AGGI.get(indiceW9aggiVector).toString()));
        }
        indiceW9aggiVector++; // indiceW9aggiVector=7
        if (verificaEsistenzaValore(rigaW9AGGI.get(indiceW9aggiVector))) {
        	tab291.setW3AGPERCRIB(Float.parseFloat(rigaW9AGGI.get(indiceW9aggiVector).toString()));
        }
        indiceW9aggiVector++; // indiceW9aggiVector=8
        if (verificaEsistenzaValore(rigaW9AGGI.get(indiceW9aggiVector))) {
        	tab291.setW3AGPERCOFF(Float.parseFloat(rigaW9AGGI.get(indiceW9aggiVector).toString()));
        }
  ...
  private static HashMap<String, String> getDatiW9FASI(Long codiceGara, Long codiceLotto, Long codiceFase, Long progressivoFase, SqlManager sqlManager)
  		throws SQLException {
  	HashMap<String, String> hm = new HashMap<String, String>();
  	
  	Vector<JdbcParametro> vectW9Fasi = (Vector<JdbcParametro>) sqlManager.getVector(
  			"select ID_SCHEDA_LOCALE, ID_SCHEDA_SIMOG from W9FASI where CODGARA=? and CODLOTT=? and FASE_ESECUZIONE=? and NUM=?", 
  					new Object[] { codiceGara, codiceLotto, codiceFase, progressivoFase } );
  	
  	if (vectW9Fasi != null && vectW9Fasi.size() > 0) {
  		if (SqlManager.getValueFromVectorParam(vectW9Fasi, 0).getValue() != null) { 
  			String idSchedaLocale = SqlManager.getValueFromVectorParam(vectW9Fasi, 0).getStringValue();
  			hm.put("ID_SCHEDA_LOCALE", idSchedaLocale);
  		}
  		if (SqlManager.getValueFromVectorParam(vectW9Fasi, 1).getValue() != null) { 
  			String idSchedaSimog = SqlManager.getValueFromVectorParam(vectW9Fasi, 1).getStringValue();
  			hm.put("ID_SCHEDA_SIMOG", idSchedaSimog);
  		}
  	}
...
/*  
  private static void getXmlComunicazioneEsito() {
    RichiestaRichiestaRispostaSincronaComunicazioneEsitoDocument comunicazioneEsitoDocument =
      RichiestaRichiestaRispostaSincronaComunicazioneEsitoDocument.Factory.newInstance();
    comunicazioneEsitoDocument.documentProperties().setEncoding(ENCODING);
    RichiestaRichiestaRispostaSincronaComunicazioneEsitoType comunicazioneEsito =
      comunicazioneEsitoDocument.addNewRichiestaRichiestaRispostaSincronaComunicazioneEsito();

    faseEstesa = comunicazioneEsito.addNewFase();
    Tab30Type tab30 = comunicazioneEsito.addNewTab30();
    
    CreazioneXmlManager.valorizzaFaseEstesaType(faseEstesa, params, codComp, num, impl, sqlManager);
    CreazioneXmlManager.valorizzaTab30Type(tab30, codGara, codLott, sqlManager, w9Manager);
    CreazioneXmlManager.valorizzaTab192BisType(comunicazioneEsito, codGara, codLott, num, sqlManager);
    xmlObject = comunicazioneEsitoDocument;
  }
