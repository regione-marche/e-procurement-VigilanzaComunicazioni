 ...
 *
 */
public class RichiestaGenerazioneCUPAction extends ActionBaseNoOpzioni {

	/** FORWARD_SUCCESS forward generazione cup avvenuta con successo. */
  protected static final String          FORWARD_SUCCESS   = "generacupsuccess";
  /** FORWARD_ERROR forward per generazione cup ha generato un errore. */
  protected static final String          FORWARD_ERROR     = "generacuperror";
  /** Logger Log4J di classe. */
  private static Logger                          logger            = Logger.getLogger(RichiestaGenerazioneCUPAction.class);
  ...
  protected ActionForward runAction(ActionMapping mapping, ActionForm form,
    ...
    if (logger.isDebugEnabled()) {
      logger.debug("GeneraCUPAction: inizio metodo");
    }
   ...
   // Leggo le eventuali credenziali memorizzate
      ...
      String cup = this.gestioneServiziCUPManager.richiestaGenerazioneCUP(id,
          cupwsuser, cupwspass, syscon);
    ...
    if (logger.isDebugEnabled()) {
    	logger.debug("GeneraCUPAction: fine metodo");
    }
