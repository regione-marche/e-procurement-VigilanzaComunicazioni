...
public class AggiornaImportiProgrammaAction extends ActionBaseNoOpzioni {
  ...
  protected ActionForward runAction(ActionMapping mapping, ActionForm form,
    ...
    String contri = request.getSession().getAttribute("contriDestinazione").toString();
    try {
      this.ptManager.aggiornaCostiPiatri(new Long(contri));
    } catch (GestoreException e) {
      target = CostantiGeneraliStruts.FORWARD_ERRORE_GENERALE;
      logger.error("errore nell'aggiornamento degli importi del programma", e);
      aggiungiMessaggio(request, "errors.incollaIntervento.aggiornamentoImporti");
    }
