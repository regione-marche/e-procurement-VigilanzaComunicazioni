 ...
 */
public class TipoStrumentoTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements it.maggioli.w9.pubblica.webservices.AppaltiLiguriaWebService2.types.TipoStrumentoType
{
    
    public TipoStrumentoTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType, false);
    }
    
    protected TipoStrumentoTypeImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
    {
        super(sType, b);
    }
}
