/**
 * AnnullaComunicazioneRequest.java
 *
...
public class AnnullaComunicazioneRequest  implements java.io.Serializable {
    private java.lang.String cig;

    private LoggedUserInfoType user;

    public AnnullaComunicazioneRequest() {
    }
    ...
    /**
     * Gets the cig value for this AnnullaComunicazioneRequest.
     * 
     * @return cig
     */
    ...
    /**
     * Sets the cig value for this AnnullaComunicazioneRequest.
     * 
     * @param cig
     */
    ...
    /**
     * Gets the user value for this AnnullaComunicazioneRequest.
     * 
     * @return user
     */
    ...
    /**
     * Sets the user value for this AnnullaComunicazioneRequest.
     * 
     * @param user
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AnnullaComunicazioneRequest)) return false;
        AnnullaComunicazioneRequest other = (AnnullaComunicazioneRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AnnullaComunicazioneRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("smartCig.ws.comunicazioni_v1.0.0", "AnnullaComunicazioneRequest"));
