...
<gene:template file="scheda-template.jsp" gestisciProtezioni="true" schema="W9" idMaschera="W9APPA-scheda">
	...
	<c:set var="flusso" value='1' scope="request" />
	...
	<c:set var="permessoUser" value='${gene:callFunction3("it.eldasoft.w9.tags.funzioni.GetPermessoUserFunction",pageContext,key,"W9APPA-A05")}' scope="request" />
		
	<gene:setString name="titoloMaschera" value='${gene:if("NUOVO"==modo, "Nuova Fase di aggiudicazione/affidamento", "Fase di aggiudicazione/affidamento")}' />
		
	<gene:redefineInsert name="corpo">
		<gene:formPagine gestisciProtezioni="true"> 

			<gene:pagina title="Dati aggiudicazione" idProtezioni="DETTFASE">
				<jsp:include page="w9appa-pg-dettaglioFase-a05.jsp" />	
			</gene:pagina>
			<gene:pagina title="Imprese aggiudicatarie / affidatarie"
				idProtezioni="IMPR">
