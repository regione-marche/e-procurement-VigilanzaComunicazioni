...
<gene:template file="lista-template.jsp" gestisciProtezioni="true" schema="W9" idMaschera="ListaCentri">
<gene:setString name="titoloMaschera" value="Lista dei Centri di Costo"/>
	<c:set var="visualizzaLink" value='${gene:checkProt(pageContext, "MASC.VIS.GENE.SchedaCentri")}' />
	...
	<gene:redefineInsert name="corpo">
		...
		<table class="lista">
			<tr>
				<td>
					<gene:formLista entita="CENTRICOSTO" where="CENTRICOSTO.CODEIN = '${sessionScope.uffint}'" sortColumn="3"
						pagesize="20" tableclass="datilista" gestisciProtezioni="true" pathScheda="w9/centricosto/centricosto-scheda.jsp">
					...
					<gene:campoLista campo="CODCENTRO" headerClass="sortable"
						width="90" href="${gene:if(visualizzaLink, link, '')}" />
	...
	<c:if test='${gene:checkProtObj(pageContext, "MASC.VIS", "GENE.SchedaCentri")}'>
		<gene:PopUpItemResource variableJs="rigaPopUpMenu"
			...
			title="Visualizza anagrafica Centri di Costo" />
	</c:if>
