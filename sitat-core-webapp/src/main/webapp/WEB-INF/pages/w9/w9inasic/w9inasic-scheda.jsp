...
<gene:template file="scheda-template.jsp" gestisciProtezioni="true"
	schema="W9" idMaschera="W9INASIC-scheda">
	...
	<c:set var="flusso" value='995' scope="request" />
	...
	<c:set var="key3" value='${gene:getValCampo(key,"NUM_INAD")}' scope="request" />

	<c:set var="permessoUser" value='${gene:callFunction3("it.eldasoft.w9.tags.funzioni.GetPermessoUserFunction",pageContext,key,"W9INASIC")}' scope="request" />

	<gene:setString name="titoloMaschera" value='${gene:if("NUOVO"==modo, "Nuova Scheda Inadempienze sicurezza", "Scheda Inadempienze sicurezza")}' />

	<gene:redefineInsert name="corpo">
		<gene:formScheda entita="W9INASIC" gestisciProtezioni="true"
			plugin="it.eldasoft.w9.tags.gestori.plugin.GestoreW9INASIC"
			gestore="it.eldasoft.w9.tags.gestori.submit.GestoreW9INASIC">
			...
			<gene:gruppoCampi idProtezioni="GEN">
				...
				<gene:campoScheda campo="NUM_INAD" modificabile="false"
					visibile="${modoAperturaScheda ne 'NUOVO'}" />
				<gene:campoScheda campo="DAINASIC" />
				<gene:campoScheda campo="COMMA3A" />
				<gene:campoScheda campo="COMMA3B" />
				<gene:campoScheda campo="COMMA45A" />
				<gene:campoScheda campo="COMMA5" />
				<gene:campoScheda campo="COMMA6" />
				<gene:campoScheda campo="COMMALTRO" />
				<gene:campoScheda campo="DESCVIO" />
				<gene:archivio titolo="IMPRESE" obbligatorio="true"
					lista='${gene:if(gene:checkProt( pageContext,"COLS.MOD.W9.W9INASIC.CODIMP"),"gene/impr/impr-lista-popup.jsp","")}'
					...
					campi="IMPR.CODIMP;IMPR.NOMEST" chiave="W9INASIC_CODIMP" 
					...
					<gene:campoScheda campo="DENOMIMPR" value="${nomeimpr}" title="Denom. Impresa Aggiudicataria" campoFittizio="true" definizione="T61" />
				</gene:archivio>
			</gene:gruppoCampi>
			
			<!-- campi per  W9FASI-->
			<gene:campoScheda campo="CODGARA" entita="W9FASI" visibile="false" defaultValue="${codgara}" 
				where="W9FASI.CODGARA = W9INASIC.CODGARA AND W9FASI.CODLOTT = W9INASIC.CODLOTT AND W9FASI.NUM = W9INASIC.NUM_INAD AND W9FASI.NUM_APPA = W9INASIC.NUM_APPA AND W9FASI.FASE_ESECUZIONE=${flusso}"/>
