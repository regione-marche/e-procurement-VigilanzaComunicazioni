...
<gene:template file="popup-template.jsp">
	...
	<gene:setString name="titoloMaschera"  value='Controllo dati per la richiesta CUP' />
	
	<gene:redefineInsert name="corpo">
		<table class="lista">

			<c:set var="stato" value='${gene:callFunction2("it.eldasoft.sil.pt.tags.funzioni.GestioneValidazioneCUPFunction",pageContext,id)}'/>		
			...
			<c:choose>
				...
				<tr>
					<td>
						<b>${titoloGenerico}</b>
						<br>&nbsp;
						Il controllo dei dati inseriti non ha rilevato alcun problema.
						<br>&nbsp;<br>				
					</td>
				</tr>
				</c:otherwise>
