...
<gene:template file="popup-template.jsp" gestisciProtezioni="true"
	schema="PIANI" idMaschera="popupEsitoRiportaIntervento">

	<gene:setString name="titoloMaschera" value="Riporta interventi" />
			...
			<tr>
				<td>
					<c:if test='${esito eq ko }' >
						L'operazione di riporto degli interventi del programma precedente &egrave; terminato con errori
						<br><br>
					</c:if>
				</td>
			</tr>
