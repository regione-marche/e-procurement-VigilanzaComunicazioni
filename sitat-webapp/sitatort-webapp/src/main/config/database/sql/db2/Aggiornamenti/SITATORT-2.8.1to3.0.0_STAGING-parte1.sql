...
--- Properties specifiche di SitatORT
--#SET TERMINATOR ;

UPDATE W_CONFIG SET VALORE='3.0.0' WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.rt.sitatproxy.versioneTracciatoXML';
UPDATE W_CONFIG SET VALORE='22' WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.sftp.port';
UPDATE W_CONFIG SET VALORE='B302/IN'  WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.sftp.areain';
UPDATE W_CONFIG SET VALORE='B302/OUT' WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.sftp.areaout';
UPDATE W_CONFIG SET VALORE='B302/BKP' WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.sftp.areabkp';
UPDATE W_CONFIG SET VALORE='NEW*.xml_feedback' WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.sftp.feedback';

--- SitatORT su DB2:

UPDATE W_CONFIG set VALORE='DB2' where CODAPP='W9' and CHIAVE='it.eldasoft.dbms';
UPDATE W_CONFIG set VALORE='Sitat Osservatorio' where CODAPP='W9' and CHIAVE='it.eldasoft.titolo';
UPDATE W_CONFIG SET VALORE='http://carttestnal.rete.toscana.it:8080/cart/IntegrationManager' WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.sitat.integrationManager.url';
UPDATE W_CONFIG SET VALORE='SPC' WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.sitat.integrationManager.tipoServizio';
UPDATE W_CONFIG SET VALORE='ComunicazioniSITAT' WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.sitat.integrationManager.nomeServizio';

UPDATE W_CONFIG SET VALORE='/apps/tix/data/SitatORT/exportXML/' WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.simog.xml.datapath';

UPDATE W_CONFIG SET VALORE='collaudosimog.avcp.it' WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.sftp.host';

UPDATE W_CONFIG SET VALORE='http://159.213.32.211:8080/cart/IntegrationManager' WHERE CODAPP='W9' AND CHIAVE='it.toscana.regione.sitat.rfc210.url';
UPDATE W_CONFIG SET VALORE='SPCRegioneToscanaOsservatorioContrattiPubblici/SPCCmetisTix2/SPCNotificaCantiereEdile' WHERE CODAPP='W9' AND CHIAVE='it.toscana.regione.sitat.rfc210.portaDelegata';
UPDATE W_CONFIG SET VALORE='NotificaCantiereEdile' WHERE CODAPP='W9' AND CHIAVE='it.toscana.regione.sitat.rfc210.servizio';
UPDATE W_CONFIG SET VALORE='SPC' WHERE CODAPP='W9' AND CHIAVE='it.toscana.regione.sitat.rfc210.tipoServizio';
UPDATE W_CONFIG SET VALORE='RegioneToscanaOsservatorioContrattiPubblici' WHERE CODAPP='W9' AND CHIAVE='it.toscana.regione.sitat.rfc210.destinatario';
UPDATE W_CONFIG SET VALORE='SPC' WHERE CODAPP='W9' AND CHIAVE='it.toscana.regione.sitat.rfc210.tipoDestinatario';

--- Attivazione di due processi schedulati: lettura dal CART e invio dei flussi al LoaderAppalto
UPDATE W_QUARTZ SET CRON_EXPRESSION='0 0/5 * * * ?',CRON_SECONDS='0',CRON_MINUTES='0/5',CRON_HOURS='*',CRON_DAY_OF_MONTH='*',CRON_MONTH='*',CRON_DAY_OF_WEEK='?',CRON_YEAR=null WHERE CODAPP='W9' AND BEAN_ID='cartMessageReaderTrigger';
UPDATE W_QUARTZ SET CRON_EXPRESSION='0 0/15 * * * ?',CRON_SECONDS='0',CRON_MINUTES='0/15',CRON_HOURS='*',CRON_DAY_OF_MONTH='*',CRON_MONTH='*',CRON_DAY_OF_WEEK='?',CRON_YEAR=null WHERE CODAPP='W9' AND BEAN_ID='esportazioneXMLSIMOGManagerTrigger';
...
--- SitatORT su DB2: dati sensibili di Staging
UPDATE W_CONFIG SET VALORE='regtoscanacoll' WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.sftp.username';
UPDATE W_CONFIG SET VALORE='cambiami' WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.sftp.password';

UPDATE W_CONFIG SET VALORE='SPCRegioneToscana_SPCComunicazioniSITAT_SIL_E' WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.sitat.integrationManager.username';
UPDATE W_CONFIG SET VALORE='pd9a$Et9X' WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.sitat.integrationManager.password';

UPDATE W_CONFIG SET VALORE='SPCRegioneToscanaOsservatorioContrattiPubblici_SPCCmetisTix2_SPCNotificaCantiereEdile_SIL_F' WHERE CODAPP='W9' AND CHIAVE='it.toscana.regione.sitat.rfc210.username';
UPDATE W_CONFIG SET VALORE='jm!gr3AJ7' WHERE CODAPP='W9' AND CHIAVE='it.toscana.regione.sitat.rfc210.password';
UPDATE W_CONFIG SET VALORE='SPCRegioneToscanaOsservatorioContrattiPubblici_SPCNotificaCantiereEdile_SIL_E' WHERE CODAPP='W9' AND CHIAVE='it.toscana.regione.sitat.rfc210.usernameErogatore';
UPDATE W_CONFIG SET VALORE='iP28_kWtf' WHERE CODAPP='W9' AND CHIAVE='it.toscana.regione.sitat.rfc210.passwordErogatore';
