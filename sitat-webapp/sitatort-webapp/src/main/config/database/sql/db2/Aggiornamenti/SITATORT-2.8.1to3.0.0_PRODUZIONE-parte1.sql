...
UPDATE W_CONFIG SET VALORE='http://pddcart-int.tix.it/cart/IntegrationManager' WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.sitat.integrationManager.url';
...
UPDATE W_CONFIG SET VALORE='simog.avcp.it' WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.sftp.host';
...
--- SitatORT su DB2: dati sensibili di Produzione
UPDATE W_CONFIG SET VALORE='toscanaprod' WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.sftp.username';
...
UPDATE W_CONFIG SET VALORE='bz~NDyo16' WHERE CODAPP='W9' AND CHIAVE='it.eldasoft.sitat.integrationManager.password';
